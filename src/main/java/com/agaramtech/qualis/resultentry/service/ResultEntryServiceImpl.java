...
//Added by Vignesh(09-09-2025)-> ALPDJ21-61 Result Entry -> sample or sub sample send to store test was not got properly.
	@Override
	public ResponseEntity<Object> getResultEntrySampleStatus(Map<String, Object> inputMap, UserInfo userInfo)	throws Exception {
		
		return resultEntryDAO.getResultEntrySampleStatus(inputMap, userInfo);
