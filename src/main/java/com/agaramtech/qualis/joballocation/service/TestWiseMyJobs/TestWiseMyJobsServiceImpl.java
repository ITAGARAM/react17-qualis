...
public class TestWiseMyJobsServiceImpl implements TestWiseMyJobsService {
	...
	@Override
	public ResponseEntity<Object> updateTestStatus(final Map<String, Object> inputMap, UserInfo userInfo)
			throws Exception {
		return testwisemyjobsDAO.updateTestStatus(inputMap, userInfo);
	}
