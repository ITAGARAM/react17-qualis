...
public class Quotation extends CustomizedResultsetRowMapper implements Serializable,RowMapper<Quotation> {
	...
	@Transient
	private String stzquotationdate;
	@Transient
	...
	public Quotation mapRow(ResultSet arg0, int arg1) throws SQLException {
		...
		objQuotation.setStzquotationdate(getString(arg0,"stzquotationdate",arg1));
		objQuotation.setStransactiondate(getString(arg0,"stransactiondate",arg1));
		objQuotation.setNoffsetdtransactiondate(getInteger(arg0,"noffsetdtransactiondate",arg1)); 
