...
//			objMap.put("MethodValidity", lstMthdValid);
			...
			if (methodvalidity.getSvaliditystartdate() != null) {
				...
				String methodInsert="";
				   methodInsert = "insert into methodvalidity(nmethodvaliditycode,nmethodcode,dvaliditystartdate,dvalidityenddate,"
						...
						+ convertedObject.getNoffsetdvaliditystartdate() + ","
						+ convertedObject.getNtzvaliditystartdatetimezone() + "" + ","
						+ convertedObject.getNoffsetdvalidityenddate() + ","
						+ convertedObject.getNtzvalidityenddatetimezone() + ",'"
	...
	public ResponseEntity<Object> createMethodValidity(MethodValidity methodvalidity, UserInfo userInfo)
		...
		if (selectedMethod == null) {
			...
			methodInsert = "insert into methodvalidity(nmethodvaliditycode,nmethodcode,dvaliditystartdate,dvalidityenddate,"
					...
					+ convertedObject.getNoffsetdvaliditystartdate() + ","
					+ convertedObject.getNtzvaliditystartdatetimezone() + "" + ","
					+ convertedObject.getNoffsetdvalidityenddate() + "," + convertedObject.getNtzvalidityenddatetimezone()
					+ ",'" + dateUtilityFunction.getCurrentDateTime(userInfo) + "',"
	...
	public ResponseEntity<Object> updateMethodValidity(MethodValidity methodvalidity, UserInfo userInfo)
		...
		final String updateQueryString = "update methodvalidity set dvaliditystartdate='"
				...
				+ "', noffsetdvaliditystartdate =" + convertedObject.getNoffsetdvaliditystartdate()
				+ ",ntzvaliditystartdatetimezone=" + convertedObject.getNtzvaliditystartdatetimezone() + ","
				+ " noffsetdvalidityenddate =" + convertedObject.getNoffsetdvalidityenddate()
				+ ",ntzvalidityenddatetimezone=" + convertedObject.getNtzvalidityenddatetimezone() + ""
	...
	public ResponseEntity<Object> getActiveMethodValidityById(int nmethodvaliditycode, final UserInfo userInfo)
		...
		final String strQuery = "select mv.nmethodvaliditycode,mv.nmethodcode,mv.ntransactionstatus,mv.dvaliditystartdate,mv.dvalidityenddate, coalesce(ts.jsondata->'stransdisplaystatus'->>'"
				...
				+ userInfo.getSpgsitedatetime() + "'),'') as svaliditystartdate ,"
				+ " COALESCE(TO_CHAR(mv.dvalidityenddate,'" + userInfo.getSpgsitedatetime()
				+ "'),'') as svalidityenddate,t1.stimezoneid as stzvaliditystartdatetimezone,"
				+ " t2.stimezoneid as stzvalidityenddatetimezone ,t1.ntimezonecode as ntzvaliditystartdatetimezone "
				+ " ,t2.ntimezonecode as ntzvalidityenddatetimezone "
				+ " from methodvalidity mv,transactionstatus ts ,timezone t1,timezone t2 " + " where mv.nstatus = "
				+ Enumeration.TransactionStatus.ACTIVE.gettransactionstatus() + " and ts.nstatus = "
				+ Enumeration.TransactionStatus.ACTIVE.gettransactionstatus()
				+ " and ts.ntranscode = mv.ntransactionstatus" + " and t1.ntimezonecode=mv.ntzvaliditystartdatetimezone "
				+ " and t2.ntimezonecode=mv.ntzvalidityenddatetimezone "
				...
				+ " and mv.nmethodvaliditycode = " + nmethodvaliditycode+" "
				+ " and mv.nsitecode="+userInfo.getNmastersitecode()+"";
