...
public interface TestMasterDAO {
   ...
   // public ResponseEntity<Object> getTestContainterType(final int ntestcode, final UserInfo userInfo) throws Exception;
	...
	public ResponseEntity<Object> importData(MultipartHttpServletRequest request, UserInfo userInfo)throws Exception;

	public ResponseEntity<Object> getTestSubContractor(int ntestcode, UserInfo objUserInfo)throws Exception;

	public ResponseEntity<Object> getSubContractor(int ntestcode, UserInfo objUserInfo)throws Exception;

	public ResponseEntity<Object> createTestSubContractor(TestSubContractor objTestSubContractor, UserInfo objUserInfo)throws Exception;

	public ResponseEntity<Object> deleteTestSubContractor(TestSubContractor objTestSubContractor, UserInfo objUserInfo)throws Exception;

	public ResponseEntity<Object> setDefaultTestSubContractor(TestSubContractor objTestSubContractor,
