...
//	}
	...
	public ResponseEntity<Object> importData(MultipartHttpServletRequest request, UserInfo userInfo)
			throws Exception {
		return testMasterDAO.importData( request, userInfo);
	}
	
	public ResponseEntity<Object> getTestSubContractor(final int ntestcode, final UserInfo objUserInfo) throws Exception{
		return testMasterDAO.getTestSubContractor(ntestcode,objUserInfo);
	}
	public ResponseEntity<Object> getSubContractor(final int ntestcode, final UserInfo objUserInfo) throws Exception{
		return testMasterDAO.getSubContractor(ntestcode,objUserInfo);
	}
	@Transactional
	public ResponseEntity<Object> createTestSubContractor(final TestSubContractor objTestSubContractor, final UserInfo objUserInfo) throws Exception{
		return testMasterDAO.createTestSubContractor(objTestSubContractor,objUserInfo);
	}
	@Transactional
	public ResponseEntity<Object> deleteTestSubContractor(final TestSubContractor objTestSubContractor, final UserInfo objUserInfo) throws Exception{
		return testMasterDAO.deleteTestSubContractor(objTestSubContractor,objUserInfo);
	}
	@Transactional
	public ResponseEntity<Object> setDefaultTestSubContractor(final TestSubContractor objTestSubContractor, final UserInfo objUserInfo) throws Exception{
		return testMasterDAO.setDefaultTestSubContractor(objTestSubContractor,objUserInfo);
	}
