...
public class TestMasterClinicalSpec extends CustomizedResultsetRowMapper<TestMasterClinicalSpec> implements Serializable, RowMapper<TestMasterClinicalSpec> {
	...
	@Column(name = "sapprovemin", length = 20)
	private String sapprovemin="";
	
	@Column(name = "sapprovemax", length = 20)
	private String sapprovemax="";
	...
	public TestMasterClinicalSpec mapRow(ResultSet arg0, int arg1) throws SQLException {
		...
		objTGTPP.setSapprovemax(StringEscapeUtils.unescapeJava(getString(arg0,"sapprovemax",arg1)));
		objTGTPP.setSapprovemin(StringEscapeUtils.unescapeJava(getString(arg0,"sapprovemin",arg1)));
