...
public class TestPackageTest extends CustomizedResultsetRowMapper<TestPackageTest> implements Serializable ,RowMapper<TestPackageTest>{
	...
	@Transient
	private transient int ntestcategorycode;
	...
	public TestPackageTest mapRow(ResultSet arg0, int arg1) throws SQLException {
		...
		objTestPakage.setStestname(getString(arg0,"stestname",arg1));
		objTestPakage.setStestsynonym(getString(arg0,"stestsynonym",arg1));
		objTestPakage.setNtestcategorycode(getInteger(arg0,"ntestcategorycode",arg1));
		objTestPakage.setStestcategoryname(getString(arg0,"stestcategoryname",arg1));
