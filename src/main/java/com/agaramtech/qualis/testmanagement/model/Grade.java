...
public class Grade extends CustomizedResultsetRowMapper<Grade> implements Serializable, RowMapper<Grade> {
	...
	@Lob
	@Column(name = "jsoncombodata", columnDefinition = "jsonb")
	private Map<String, Object> jsoncombodata;
	...
	@Transient
	private transient String scombodisplaystatus;
	...
	public Grade mapRow(ResultSet arg0, int arg1) throws SQLException {
		...
		objGrade.setJsoncombodata(unescapeString(getJsonObject(arg0, "jsoncombodata", arg1)));
		...
		objGrade.setScombodisplaystatus(getString(arg0, "scombodisplaystatus", arg1));
