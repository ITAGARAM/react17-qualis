...
public class SchedulerConfigurationDAOImpl implements SchedulerConfigurationDAO {
	...
	public ResponseEntity<Object> getSchedulerConfigTemplate(final int nregTypeCode,final int nregSubTypeCode) throws Exception {
	...
	public ResponseEntity<Object> getSchedulerConfigTemplatebasedontemplatecode(final int nregTypeCode,final int nregSubTypeCode,
	...
	public Map<String, Object> getDynamicSchedulerConfig(Map<String, Object> inputMap,final UserInfo userInfo)
			throws Exception {
		...
		final String strSampleQry = "select json_agg(a.jsonuidata) from (select ssd.nschedulersamplecode, ssd.nallottedspeccode, "
	...
	public ResponseEntity<Object> getSchedulerConfigSubSample(Map<String, Object> inputMap,final UserInfo userInfo)
		...
		final String strSubSampleQry = "select json_agg(a.jsonuidata) from (select sssd.nschedulersubsamplecode, cm.ncolorcode, cm.scolorhexcode,coalesce(ts.jsondata->'stransdisplaystatus'->>'"
				+ userInfo.getSlanguagetypecode()
	...
	public ResponseEntity<Object> getSchedulerConfigSubSampleTemplate(final int ndesigntemplatemappingcode) throws Exception {
	...
	public ResponseEntity<Object> getComponentBySpec(Map<String, Object> inputMap) throws Exception {
		...
		final int ntemplatemanipulationcode = (int) inputMap.get("ntemplatemanipulationcode");
		...
		final String dreceivedate = dateUtilityFunction.instantDateToString(date);

		final String str = "select  tgs.nspecsampletypecode, " + " co.ncomponentcode,co.scomponentname,"
	...
	public ResponseEntity<Object> createSubSample(Map<String, Object> inputMap) throws Exception {
		...
		final SchedulerSubSampleDetail schedulerConfigSample = objmap.convertValue(
	...
	public ResponseEntity<Object> getMoreTest(final Map<String, Object> inputMap, final UserInfo userInfo)
			throws Exception {
		final String sTestQuery = "select tgt.nrepeatcountno," 
	...
	public List<Map<String, Object>> auditTestGet(Map<String, Object> inputMap,final UserInfo userInfo) throws Exception {
		List<Map<String, Object>> lstData = new ArrayList<>();
		...
		final String strTestQry = "select json_agg(a.jsondata) from (select nschedulertestcode,ssd.ntransactionstatus, cm.ncolorcode, cm.scolorhexcode,coalesce(ts.jsondata->'stransdisplaystatus'->>'"
				+ userInfo.getSlanguagetypecode()
				+ "', ts.jsondata->'stransdisplaystatus'->>'en-US') stransdisplaystatus, "
				+ "std.jsondata || json_build_object('stransdisplaystatus', coalesce(ts.jsondata->'stransdisplaystatus'->>'"
				+ userInfo.getSlanguagetypecode() + "',"
	...
	public List<Map<String, Object>> auditSubSampleGet(Map<String, Object> inputMap,final UserInfo userInfo)
			throws Exception {
		List<Map<String, Object>> lstData = new ArrayList<>();
	...
	public List<Map<String, Object>> auditSampleGet(Map<String, Object> inputMap,final UserInfo userInfo) throws Exception {
		List<Map<String, Object>> lstData = new ArrayList<>();
