 ...
 * 31/08/2025
 */
public interface SiteSampleExpiryMappingService {

	/**
	 * This service interface declaration will access the DAO layer that is used to
	 * get all the available siteexpirymapping's with respect to site
	 * 
	 * @param userInfo [UserInfo] holding logged in user details and nmasterSiteCode
	 *                 [int] primary key of site object for which the list is to be
	 *                 fetched
	 * @return a response entity which holds the list of siteexpirymapping records
	...
	/**
	 * This service interface declaration will access the DAO layer that is used to
	 * get single or list of periods with respect to site
	 * 
	 * @param userInfo [UserInfo] holding logged in user details and nmasterSiteCode
	 *                 [int] primary key of site object for which the list is to be
	 *                 fetched
	 * @return a response entity which holds the a single or list of period records
	 *         with respect to site
	 * @throws Exception that are thrown in the DAO layer
	 */
	 ...
	 * 
	 * @param objSiteSampleExpiryMapping [SiteSampleExpiryMapping] object holding details to be
	 *                           added in siteexpirymapping table
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> createSiteSampleExpiryMapping(final SiteSampleExpiryMapping objSiteSampleExpiryMapping,
			final UserInfo userInfo) throws Exception;
	 ...
	 * 
	 * @param objSiteSampleExpiryMapping [SiteSampleExpiryMapping] object holding details to be
	 *                           updated in siteexpirymapping table
	 * @param userInfo           [UserInfo] holding logged in user details and
	 *                           nmasterSiteCode [int] primary key of site object
	 *                           for which the list is to be fetched
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> updateSiteSampleExpiryMapping(final SiteSampleExpiryMapping objSiteSampleExpiryMapping,
			final UserInfo userInfo) throws Exception;
	 ...
	 * 
	 * @param objSiteSampleExpiryMapping [SiteSampleExpiryMapping] object holding detail to be
	 *                           deleted from siteexpirymapping table
	 * @param userInfo           [UserInfo] holding logged in user details and
	 *                           nmasterSiteCode [int] primary key of site object
	 *                           for which the list is to be fetched
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> deleteSiteSampleExpiryMapping(final SiteSampleExpiryMapping objSiteSampleExpiryMapping,
			final UserInfo userInfo) throws Exception;
}
