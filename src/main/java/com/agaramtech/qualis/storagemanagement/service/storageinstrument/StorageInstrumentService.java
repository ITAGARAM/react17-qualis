...
/**
 * This interface declaration holds methods to perform CRUD operation on 'storageinstrument' table
 */
public interface StorageInstrumentService {
	 ...
	 * @return response entity object holding response status and list of all Storage Instrument
	 * @throws Exception exception
	 */
	public ResponseEntity<Object> getStorageInstrument(UserInfo userInfo) throws Exception;
	 ...
	 * @throws Exception exception
	 */
	public ResponseEntity<Object> createStorageInstrument(Map<String,Object> inputMap) throws Exception;
	 ...
	 * @throws Exception exception
	 */
	public ResponseEntity<Object> updateStorageInstrument(Map<String,Object> inputMap) throws Exception;
	 ...
	 * @throws Exception exception
	 */
	public ResponseEntity<Object> deleteStorageInstrument(Map<String,Object> inputMap) throws Exception;
	 ...
	 * @throws Exception exception
	 */
	public ResponseEntity<Object> getStorageStructure(Map<String,Object> inputMap) throws Exception;
	 ...
	 * @throws Exception exception
	 */
	public ResponseEntity<Object> getStorageInstrumentCategory(Map<String,Object> inputMap) throws Exception;
	 ...
	 * @throws Exception exception
	 */
	public ResponseEntity<Map<String,Object>> getInstrumentByCategory(Map<String,Object> inputMap) throws Exception;
