...
public interface SampleStorageRetrievalService {
	 ...
	 * 							  which the list is to be fetched 	
	 * 					Input : {"userinfo":{nmastersitecode": -1,ntransitecode:1}}				
	 * @return response entity  object holding response status and list of all expired samples based on the expiry days
	 *  mapped in site retention mapping
	 * @throws Exception exception
	 */
	...
	//added by sujatha ATE_274 for dispose expired samples SWSM-37 12-09-2025
	/**
	 * This method is used to retrieve expired sample based on what the user enter in the Rentention period in days 
	 * @param inputMap  [Map] map object with userInfo [UserInfo] holding logged in user details and
	 *  nmasterSiteCode [int] primary key of site object for 
	 * 							  which the list is to be fetched 	
	 * 					Input : {"userinfo":{nmastersitecode": -1,ntransitecode:1}}				
	 * @return response entity  object holding response status and expired sample based on what the user enter in the 
	 * Rentention period in days
	 * @throws Exception exception
	 */
	 ...
	 * 							  which the list is to be fetched 	
	 * 					Input : {"userinfo":{nmastersitecode": -1,ntransitecode:1}}				
	 * @return response entity  object holding response status and used to dispose one or more samples simultaneously and to 
