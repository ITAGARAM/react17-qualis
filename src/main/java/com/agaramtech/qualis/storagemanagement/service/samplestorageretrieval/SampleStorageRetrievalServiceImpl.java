...
//	public SampleStorageRetrievalServiceImpl(SampleStorageRetrievalDAO SampleStorageRetrievalDAO, CommonFunction commonFunction) {
//		super();
//		this.SampleStorageRetrievalDAO = SampleStorageRetrievalDAO;
...
//	}
	...
	/**
	 * This method is used to retrieve list of expired samples based on the expiry days mapped in site retention mapping. 
	 * @param inputMap  [Map] map object with userInfo [UserInfo] holding logged in user details and nmasterSiteCode [int] 
	 * primary key of site object for 
	 * 							  which the list is to be fetched 	
	 * 					Input : {"userinfo":{nmastersitecode": -1,ntransitecode:1}}				
	 * @return response entity  object holding response status and list of all expired samples based on the 
	 * expiry days mapped in site retention mapping
	 * @throws Exception exception
	 */
	public ResponseEntity<Object> getSampleStorageTransaction(final Map<String, Object> inputMap) throws Exception {
		return SampleStorageRetrievalDAO.getSampleStorageTransaction(inputMap);
	} 
	 ...
	 * 							  which the list is to be fetched 	
	 * 					Input : {"userinfo":{nmastersitecode": -1,ntransitecode:1}}				
	 * @return response entity  object holding response status and the logged in site and the expiry days
	 * @throws Exception exception
	 */
	public ResponseEntity<Object> getSiteSampleExpiryMapping(final Map<String, Object> inputMap, UserInfo userInfo) throws Exception {
		 return SampleStorageRetrievalDAO.getSiteSampleExpiryMapping(inputMap);
	} 
	
	//added by sujatha ATE_274 for dispose expired samples SWSM-37 12-09-2025
	/**
	 * This method is used to retrieve list of xpired sample based on what the user enter in the Rentention period in days. 
	 * @param inputMap  [Map] map object with userInfo [UserInfo] holding logged in user details and nmasterSiteCode [int] primary key of site object for 
	 * 							  which the list is to be fetched 	
	 * 					Input : {"userinfo":{nmastersitecode": -1,ntransitecode:1}}				
	 * @return response entity  object holding response status and list of all xpired sample based on what the user enter in
	 *  the Rentention period in days
	 * @throws Exception exception
	 */
	public ResponseEntity<Object> getExpiredSample(final Map<String, Object> inputMap) throws Exception {
		return SampleStorageRetrievalDAO.getExpiredSample(inputMap);
	} 
	
	//added by sujatha ATE_274 for dispose expired samples SWSM-37 12-09-2025
	/**
	 * This method is used to dispose one or more samples simultaneously and to retrieve list of
	 *  disposed samples with their details.
	 * @param inputMap  [Map] map object with userInfo [UserInfo] holding logged in user details and nmasterSiteCode [int] primary key of site object for 
	 * 							  which the list is to be fetched 	
	 * 					Input : {"userinfo":{nmastersitecode": -1,ntransitecode:1}}				
	 * @return response entity  object holding response status and dispose one or more samples simultaneously and to retrieve list of
	 *  disposed samples with their details.
	 */
	@Transactional
	public ResponseEntity<Object> createDisposeExpiredSample(final Map<String, Object> inputMap, final UserInfo userInfo) throws Exception {
		return SampleStorageRetrievalDAO.createDisposeExpiredSample(inputMap, userInfo);
	} 
