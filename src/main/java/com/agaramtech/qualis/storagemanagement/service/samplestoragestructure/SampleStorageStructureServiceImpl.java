...
public class SampleStorageStructureServiceImpl implements SampleStorageStructureService {
	...
	*/
	 ...
	 */
	@Override
	public ResponseEntity<Object> checkStorageInstrumentVersion(final Map<String, Object> inputMap, final UserInfo userInfo) throws Exception {
		return sampleStorageStructureDAO.checkStorageInstrumentVersion(inputMap,
				userInfo);
	}
}
