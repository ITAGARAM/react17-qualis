...
//	@Transient
//	private transient String spositionval;
	...
	public SampleStorageRetrieval mapRow(ResultSet arg0, int arg1) throws SQLException {
		...
		samplestorageretrieval.setSsampleid(getString(arg0, "ssampleid", arg1));
		samplestorageretrieval.setSsampleid(getString(arg0, "ssitename", arg1));
