...
public class StorageSampleCollection extends CustomizedResultsetRowMapper<StorageSampleCollection>
	...
	@Column(name = "dcollectiondatetime", nullable = false)
	private Instant dcollectiondatetime;
	...
	private short ntzcollectiondatetime;
	...
	//Modified by sonia on 18th July 2025 for jira id:ALPDJ21-18
	@Transient
	private transient String scollectiondatetime;
	...
	public StorageSampleCollection mapRow(ResultSet arg0, int arg1) throws SQLException {
		...
		objSampleCollection.setDcollectiondatetime(getInstant(arg0, " dcollectiondatetime", arg1)); //Modified by sonia on 18th July 2025 for jira id:ALPDJ21-18
		objSampleCollection.setNsampleqty(getDouble(arg0, "nsampleqty", arg1));
		objSampleCollection.setNtzcollectiondatetime(getShort(arg0, "ntzcollectiondatetime", arg1)); //Modified by sonia on 18th July 2025 for jira id:ALPDJ21-18
		...
		objSampleCollection.setScollectiondatetime(getString(arg0, "scollectiondatetime", arg1)); //Modified by sonia on 18th July 2025 for jira id:ALPDJ21-18
		...
		objSampleCollection.setNinputtimezonecode(getShort(arg0, "ninputtimezonecode", arg1)); //Added by sonia on 18th July 2025 for jira id:ALPDJ21-18
		objSampleCollection.setStimezoneid(getString(arg0, "stimezoneid", arg1)); //Added by sonia on 18th July 2025 for jira id:ALPDJ21-18
