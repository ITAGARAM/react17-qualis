...
public class TechniqueTest extends CustomizedResultsetRowMapper<TechniqueTest> implements Serializable, RowMapper<TechniqueTest> {
	...
	public TechniqueTest mapRow(ResultSet arg0, int arg1) throws SQLException {
		...
		objTechniqueTest.setStestsynonym(getString(arg0, "stestsynonym", arg1)); //Added by sonia on 28th August 2025 for jira id:SWSM-15
		objTechniqueTest.setNtrainingneed(getInteger(arg0, "ntrainingneed", arg1)); //Added by sonia on 28th August 2025 for jira id:SWSM-15
