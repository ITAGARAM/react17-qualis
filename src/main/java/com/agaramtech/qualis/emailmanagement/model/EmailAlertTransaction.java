...
public class EmailAlertTransaction extends CustomizedResultsetRowMapper<EmailAlertTransaction>
	...
	//Modified the datatype from int to short by sonia on 18th Nov 2025 for jira id:BGSI-234
	@Column(name = "nisemail", nullable = false)
	private short nisemail;
	...
	@Column(name = "sccemail", length = 200 )
	...
	public EmailAlertTransaction mapRow(ResultSet arg0, int arg1) throws SQLException {
		...
		emailAlertTransaction.setNisemail(getShort(arg0, "nisemail", arg1));	// Added by Gowtham on 27th Sept 2025 for jira id:SWSM-64
		...
		emailAlertTransaction.setSccemail(StringEscapeUtils.unescapeJava(getString(arg0, "sccemail", arg1))); 	//Added by sonia on 10th Sept 2025 for jira id:SWSM-12
		...
		emailAlertTransaction.setNcontrolcode(getShort(arg0, "ncontrolcode", arg1)); //Modified the datatype from int to short by sonia on 18th Nov 2025 for jira id:BGSI-234
		emailAlertTransaction.setNemailscreenschedulercode(getShort(arg0, "nemailscreenschedulercode", arg1)); 	//Added by sonia on 18th Nov 2025 for jira id:BGSI-234
		emailAlertTransaction.setNstatus(getShort(arg0, "nstatus", arg1)); //Modified the datatype from int to short by sonia on 18th Nov 2025 for jira id:BGSI-234
