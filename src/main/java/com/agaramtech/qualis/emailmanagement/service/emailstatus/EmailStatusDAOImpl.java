...
public class EmailStatusDAOImpl implements EmailStatusDAO {
	...
	public ResponseEntity<Object> reSentMail(Integer nrunningno, Integer ncontrolcode, UserInfo userInfo)
		...
		//Modified the insert query by sonia on 13th Oct 2025 for jira id:SWSM-91
		String query = " insert into emailalerttransaction(nrunningno,ntransactionno,nemailconfigcode,dcreateddate,dmodifieddate,semail,sreason,nstatus,nsitecode,ssubject,stemplatebody,ssystemid,nusercode,ncontrolcode,nisemail) select  "
				...
				+ ",ssubject,stemplatebody,ssystemid," + userInfo.getNusercode() + ", " + ncontrolcode +",nisemail "
