...
public class TestGroupSpecSampleType extends CustomizedResultsetRowMapper<TestGroupSpecSampleType> implements Serializable, RowMapper<TestGroupSpecSampleType> {
	...
	@Transient
	private transient String sversion;
	@Transient
	...
	public TestGroupSpecSampleType mapRow(ResultSet arg0, int arg1) throws SQLException {
		...
		objTestGroupSpecSampleType.setSversion(getString(arg0,"sversion",arg1));
		objTestGroupSpecSampleType.setStransdisplaystatus(getString(arg0,"stransdisplaystatus",arg1));
		objTestGroupSpecSampleType.setSspecname(getString(arg0,"sspecname",arg1));
