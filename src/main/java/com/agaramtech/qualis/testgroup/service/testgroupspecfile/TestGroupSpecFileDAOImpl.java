...
public class TestGroupSpecFileDAOImpl implements TestGroupSpecFileDAO {
	...
	public ResponseEntity<Object> updateSpecificationFile(UserInfo userInfo, MultipartHttpServletRequest request)
		...
		//ALPDJ21-132-Added by suriaprahash(11/12/25)--Resolved S3 File override issue and ensured file copy sync with storage
								...
								String oldFileExtension = objTGSF.getSfilename().contains(".") ? 
										objTGSF.getSfilename().substring(objTGSF.getSfilename().lastIndexOf('.') + 1) : "";
								...
								if(!oldFileExtension.equals(newFileExtension)) {
									ftpUtilityFunction.deleteFTPFile(Arrays.asList(objTGSF.getSsystemfilename()), "", userInfo);
								}
