...
public class TestGroupServiceImpl implements TestGroupService {
	...
	@Override
	@Transactional
	public ResponseEntity<Object> updateTestSorter(final Map<String, Object> inputMap,final UserInfo objUserInfo)
			throws Exception {
		return testGroupDAO.updateTestSorter(inputMap, objUserInfo);
	}
	
	@Override
	public ResponseEntity<Object> getTestGroupParameter(final Map<String, Object> inputMap,final UserInfo objUserInfo)
			throws Exception {
		return testGroupDAO.getTestGroupParameter(inputMap, objUserInfo);
	}
	
	@Override
	@Transactional
	public ResponseEntity<Object> updateTestParameterSorter(final Map<String, Object> inputMap,final UserInfo objUserInfo)
			throws Exception {
		return testGroupDAO.updateTestParameterSorter(inputMap, objUserInfo);
	}
}
