...
public class AuditTrailServiceImpl implements AuditTrailService {
	...
	@Transactional
	@Override
	public ResponseEntity<Object> createAuditArchival(final AuditArchivalRecords audit,final UserInfo userInfo) throws Exception{
		
		return auditTrailDAO.createAuditArchival(audit,userInfo);
	}
	
	public ResponseEntity<Object> getAuditArchivalHistory(final UserInfo userInfo) throws Exception {
		return auditTrailDAO.getAuditArchivalHistory(userInfo);
	}
}