...
/**
 * This interface holds declarations to perform CRUD operation on 'diseasecategory' table
 */
/**
 * @author sujatha.v
 * BGSI-1
...
public interface DiseaseCategoryDAO {
	...
	/**
	 * This interface declaration is used to get all the available diseasecategory's with respect to site
	...
	/**
	 * This interface declaration is used to retrieve active diseasecategory object based
	...
	/**
	 * This interface declaration is used to add a new entry to diseasecategory table.
	...
	/**
	 * This interface declaration is used to update entry in diseasecategory table.
	...
	/**
	 * This interface declaration is used to delete an entry in diseasecategory table.
