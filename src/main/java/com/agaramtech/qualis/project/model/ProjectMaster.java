...
public class ProjectMaster extends CustomizedResultsetRowMapper<ProjectMaster> implements Serializable,RowMapper<ProjectMaster> {
	...
	@Transient
	private  transient Instant dprojectcompletiondate;
	
	@Transient
	private transient String stransactiondate;
	
	@Transient
	private transient String srfwtimezoneid;
	@Transient
	private transient String sprojectstarttimezoneid;
	@Transient
	private transient String sexpectcompletiontimezoneid;
...
public ProjectMaster mapRow(ResultSet arg0, int arg1) throws SQLException {
	...
	objProjectMaster.setNinputtimezonecode(getShort(arg0, "ninputtimezonecode", arg1)); 
	objProjectMaster.setDprojectcompletiondate(getInstant(arg0,"dprojectcompletiondate",arg1));
	objProjectMaster.setStransactiondate(getString(arg0,"stransactiondate",arg1));
	objProjectMaster.setSrfwtimezoneid(getString(arg0,"srfwtimezoneid",arg1));
	objProjectMaster.setSprojectstarttimezoneid(getString(arg0,"sprojectstarttimezoneid",arg1));
	objProjectMaster.setSexpectcompletiontimezoneid(getString(arg0,"sexpectcompletiontimezoneid",arg1));
