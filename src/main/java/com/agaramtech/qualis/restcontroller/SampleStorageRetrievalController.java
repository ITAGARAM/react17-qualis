...
public class SampleStorageRetrievalController {
	 ...
	 *                 object for which the list is to be fetched Input :
	 *                 {"userinfo":{nmastersitecode": -1,ntransitecode:1}}
	 * @return response entity object holding response status and list of Expired Sample as per the expiry days mapped in site
	 * retention mapping
	 * @throws Exception exception
	 */
	@PostMapping(value = "/getSampleStorageTransaction")
	public ResponseEntity<Object> getSampleStorageTransaction(@RequestBody Map<String, Object> inputMap)throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		requestContext.setUserInfo(userInfo);
		return samplestorageretrievalservice.getSampleStorageTransaction(inputMap);			
	}
	 ...
	 *                 object for which the list is to be fetched Input :
	 *                 {"userinfo":{nmastersitecode": -1,ntransitecode:1}}
	 * @return response entity object holding response status and logged in site with the expiry days
	 * @throws Exception exception
	 */
	...
	public ResponseEntity<Object> getSiteSampleExpiryMapping(@RequestBody Map<String, Object> inputMap)throws Exception {
		...
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		requestContext.setUserInfo(userInfo);
		return samplestorageretrievalservice.getSiteSampleExpiryMapping(inputMap, userInfo);			
	}
	//added by sujatha ATE_274 for dispose expired samples SWSM-37 12-09-2025
	/**
	 * This method is used to retrieve list of expired sample based on what the user enter in the Rentention period in days.
	 * 
	 * @param inputMap [Map] map object with userInfo [UserInfo] holding logged in
	 *                 user details and nmasterSiteCode [int] primary key of site
	 *                 object for which the list is to be fetched Input :
	 *                 {"userinfo":{nmastersitecode": -1,ntransitecode:1}}
	 * @return response entity object holding response status and list of all expired sample
	 * based on what the user enter in the Rentention period in days. 
	 * @throws Exception exception
	 */
	@PostMapping(value = "/getExpiredSample")
	public ResponseEntity<Object> getExpiredSample(@RequestBody Map<String, Object> inputMap)throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		requestContext.setUserInfo(userInfo);
		return samplestorageretrievalservice.getExpiredSample(inputMap);			
	}
	
	//added by sujatha ATE_274 for dispose expired samples SWSM-37 12-09-2025
	/**
	 * This method is used to dispose one or more samples simultaneously and to retrieve list of disposed samples with their details.
	 * 
	 * @param inputMap [Map] map object with userInfo [UserInfo] holding logged in
	 *                 user details and nmasterSiteCode [int] primary key of site
	 *                 object for which the list is to be fetched Input :
	 *                 {"userinfo":{nmastersitecode": -1,ntransitecode:1}}
	 * @return response entity object holding response status and list of all disposed samples with their details
	 * @throws Exception exception
	 */
	@PostMapping(value = "/createDisposeExpiredSample")
	public ResponseEntity<Object> createDisposeExpiredSample(@RequestBody Map<String, Object> inputMap)throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		requestContext.setUserInfo(userInfo);
		return samplestorageretrievalservice.createDisposeExpiredSample(inputMap, userInfo);			
	}
