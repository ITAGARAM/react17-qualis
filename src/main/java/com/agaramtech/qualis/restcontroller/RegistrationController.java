...
public class RegistrationController {
	...
	public ResponseEntity<Object> getTestGroupSpecification(@RequestBody Map<String, Object> objmap) throws Exception {
		...
		int ntestGroupSpecRequired = 4; // ALPD-4834,Vishakh, Added ntestGroupSpecRequired to handle show or hide add
										// spec button
		...
		return registrationService.getTestGroupSpecification(ntreetemplatemanipulationcode, npreregno,
...
///////////////////////////////////////////
	...
	public ResponseEntity<Object> viewExternalOrderAttachment(@RequestBody Map<String, Object> inputMap,
		...
		final Map<String, Object> outputMap = registrationService
				.viewExternalOrderAttachment(objExternalOrderAttachmentFile, ncontrolCode, userInfo);
		requestContext.setUserInfo(userInfo);
		return new ResponseEntity<Object>(outputMap, HttpStatus.OK);
	}
	...
	public ResponseEntity<Object> createAdhocTest(@RequestBody Map<String, Object> inputMap) throws Exception {
		...
		final int nregtypecode = (int) inputMap.get("nregtypecode");
		final int nregsubtypecode = (int) inputMap.get("nregsubtypecode");
		return registrationService.createAdhocTest(userInfo, listSample, listTest, nregtypecode, nregsubtypecode,
				inputMap);
	...
	// Added by Dhanushya RI for JIRA ID:ALPD-4912,ALPD-4913,ALPD-4914 Filter save
	// detail --Start
	...
	/**
	 * This Method is used to get the over all instrumentcategory with respect to
	 * test
	 * 
	 * @param inputMap [Map] contains key userinfo which holds the value of
	 *                 respective user detail
	 ...
	 * @throws Exception
	 */
	@PostMapping(value = "/getTestInstrumentCategory")
	public ResponseEntity<Object> getTestInstrumentCategory(@RequestBody Map<String, Object> inputMap)
			throws Exception {

		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		requestContext.setUserInfo(userInfo);
		return registrationService.getTestInstrumentCategory(inputMap, userInfo);
	}
	 ...
	 * @throws Exception
	 */
	@PostMapping(value = "/updateTestInstrumentCategory")
	public ResponseEntity<Object> updateTestInstrumentCategory(@RequestBody Map<String, Object> inputMap)
			throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), new TypeReference<UserInfo>() {
		});
		requestContext.setUserInfo(userInfo);
		return registrationService.updateTestInstrumentCategory(inputMap, userInfo);
	}
	...
	public ResponseEntity<Object> getTestPackage(@RequestBody Map<String, Object> inputMap) throws Exception {
		...
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		requestContext.setUserInfo(userInfo);
		return registrationService.getTestPackage(inputMap, userInfo);
	}

	@PostMapping(value = "/getSubSampleBasedOnTestPackage")
	public ResponseEntity<Object> getSubSampleBasedOnTestPackage(@RequestBody Map<String, Object> inputMap)
			throws Exception {

		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		requestContext.setUserInfo(userInfo);
		return registrationService.getSubSampleBasedOnTestPackage(inputMap, userInfo);
	}

	// ate234 janakumaALPDJ21-57 Sent to Store -> Sample registration & Result entry
	@PostMapping(value = "/getRegistrationSentToStore")
	public ResponseEntity<Object> getRegistrationSentToStore(@RequestBody Map<String, Object> inputMap)
			throws Exception {

		ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		requestContext.setUserInfo(userInfo);
		return registrationService.getRegistrationSentToStore(inputMap, userInfo);
	}

	// ate234 janakumaALPDJ21-57 Sent to Store -> Sample registration & Result entry
	@PostMapping(value = "/getRegistrationSampleStatus")
	public ResponseEntity<Object> getRegistrationSampleStatus(@RequestBody Map<String, Object> inputMap)
			throws Exception {

		ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		requestContext.setUserInfo(userInfo);
		return registrationService.getRegistrationSampleStatus(inputMap, userInfo);
	}
	 ...
	 * @throws Exception
	 */
	@PostMapping(value = "/getTestPackageBySample")
		public ResponseEntity<Map<String,Object>> getTestPackageBySample(@RequestBody Map<String, Object> inputMap)
				throws Exception {
			...
			requestContext.setUserInfo(userInfo);
			return registrationService.getTestPackageBySample(spreregno, userInfo);
		}
