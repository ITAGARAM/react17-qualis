...
*/
	 ...
	 * @throws Exception exception
	 */
	@PostMapping(value = "/checkStorageInstrumentVersion")
	public ResponseEntity<Object> checkStorageInstrumentVersion(@RequestBody Map<String, Object> inputMap) throws Exception {
		final ObjectMapper objmapper = new ObjectMapper();

		final UserInfo userInfo = objmapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		requestContext.setUserInfo(userInfo);
		return sampleStorageStructureService.checkStorageInstrumentVersion(inputMap, userInfo);
	}
