 ...
 * methods to access the TestMaster Service methods.
 */
...
public class TestMasterController {
	...
	public TestMasterController(RequestContext requestContext, TestMasterService testMasterService,
	...
	public ResponseEntity<Object> getOtherTestDetails(@RequestBody Map<String, Object> inputMap) throws Exception {
		...
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		requestContext.setUserInfo(userInfo);
		return testMasterService.getOtherTestDetails(nFlag, ntestcode, ntestparametercode, userInfo,
				nclinicaltyperequired);
	}
	
	@PostMapping(value = "/getTestMasterBasedOnTestCategory")
	public ResponseEntity<Object> getTestMasterBasedOnTestCategory(@RequestBody Map<String, Object> inputMap)
			throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
	...
	public ResponseEntity<Object> createTestMaster(@RequestBody Map<String, Object> inputMap) throws Exception {
		...
		final TestParameter objTestParameter = objMapper.convertValue(inputMap.get("testparameter"),
				TestParameter.class);
		...
		final TestInstrumentCategory objTestInstCat = objMapper.convertValue(inputMap.get("testinstrumentcategory"),
				TestInstrumentCategory.class);
		final TestPackageTest objTestpackage = objMapper.convertValue(inputMap.get("testpackagetest"),
				TestPackageTest.class);
		...
		requestContext.setUserInfo(userInfo);
		return testMasterService.createTestMaster(objTestMaster, userInfo, objTestParameter, objSection, objMethod,
				objTestInstCat, objTestpackage, isQualisLite);
	}
	...
	public ResponseEntity<Object> validateTestExistenceInTestGroup(@RequestBody Map<String, Object> inputMap)
			throws Exception {
		final ObjectMapper objmapper = new ObjectMapper();
		final UserInfo userInfo = objmapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		final Integer ntestCode = (Integer) inputMap.get("ntestcode");
	...
	public ResponseEntity<Object> createTestSection(@RequestBody Map<String, Object> inputMap) throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();	
		final List<TestSection> lstTestSection = objMapper.convertValue(inputMap.get("testsection"),
				new TypeReference<List<TestSection>>() {
				});
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class); 
		requestContext.setUserInfo(userInfo);
	...
	public ResponseEntity<Object> createTestMethod(@RequestBody Map<String, Object> inputMap) throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();	
		final List<TestMethod> lstTestMethod = objMapper.convertValue(inputMap.get("testmethod"),
				new TypeReference<List<TestMethod>>() {
				});
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		// ALPD-4831,5873--Vignesh R(08-10-2024)--When nsettingcode 71 is set to 4, then
		// QualisLite= true and the Test Group is not required and is automatically
	...
	public ResponseEntity<Object> getAvailableInstrumentCategory(@RequestBody Map<String, Object> inputMap)
			throws Exception {
	...
	public ResponseEntity<Object> createInstrumentCategory(@RequestBody Map<String, Object> inputMap) throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();	
		final List<TestInstrumentCategory> lstTestInstrumentCategory = objMapper.convertValue(
				inputMap.get("testinstrumentcategory"), new TypeReference<List<TestInstrumentCategory>>() {
				});
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		// ALPD-4831,5873--Vignesh R(08-10-2024)--When nsettingcode 71 is set to 4, then
		// QualisLite= true and the Test Group is not required and is automatically
	...
	public ResponseEntity<Object> createTestpackage(@RequestBody Map<String, Object> inputMap) throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();	
		final List<TestPackageTest> lstTestInstrumentCategory = objMapper.convertValue(inputMap.get("testpackage"),
				new TypeReference<List<TestPackageTest>>() {
				});
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		// ALPD-4831,5873--Vignesh R(08-10-2024)--When nsettingcode 71 is set to 4, then
		// QualisLite= true and the Test Group is not required and is automatically
	...
	public ResponseEntity<Object> deleteInstrumentCategory(@RequestBody Map<String, Object> inputMap) throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class); 
		final TestInstrumentCategory objTestInstrumentCategory = objMapper
				.convertValue(inputMap.get("testinstrumentcategory"), TestInstrumentCategory.class);
		// ALPD-4831,5873--Vignesh R(08-10-2024)--When nsettingcode 71 is set to 4, then
		// QualisLite= true and the Test Group is not required and is automatically
		// updated by default in the relevant test group-related tables.
		final int isQualisLite=(int)inputMap.get("isQualisLite");
	...
	public ResponseEntity<Object> deletePackage(@RequestBody Map<String, Object> inputMap) throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class); 
		final TestPackageTest objTestInstrumentCategory = objMapper.convertValue(inputMap.get("package"),
				TestPackageTest.class);
		requestContext.setUserInfo(userInfo);
	...
	public ResponseEntity<Object> updateTestParameter(@RequestBody Map<String, Object> inputMap) throws Exception {
		...
		final TestParameter objTestParameter = objMapper.convertValue(inputMap.get("testparameter"),
				TestParameter.class);
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		// ALPD-4831,5873--Vignesh R(08-10-2024)--When nsettingcode 71 is set to 3, the
	...
	public ResponseEntity<Object> createTestPredefinedParameter(@RequestBody Map<String, Object> inputMap)
			throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		final TestPredefinedParameter objTestPredefinedParameter = objMapper
				.convertValue(inputMap.get("testpredefinedparameter"), TestPredefinedParameter.class);
		// ALPD-4831,5873--Vignesh R(08-10-2024)--When nsettingcode 71 is set to 4, then
		// QualisLite= true and the Test Group is not required and is automatically
		// updated by default in the relevant test group-related tables.
		final int isQualisLite=(int)inputMap.get("isQualisLite");
	...
	public ResponseEntity<Object> updateTestPredefinedParameter(@RequestBody Map<String, Object> inputMap)
			throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		final TestPredefinedParameter objTestPredefinedParameter = objMapper
	...
	public ResponseEntity<Object> deleteTestPredefinedParameter(@RequestBody Map<String, Object> inputMap)
			throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		final TestPredefinedParameter objTestPredefinedParameter = objMapper
	...
	public ResponseEntity<Object> getParameterSpecificationByCount(@RequestBody Map<String, Object> objmap)
			throws Exception {
		final int ntestParameterCode = (int) objmap.get("ntestparametercode");
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(objmap.get("userinfo"), UserInfo.class);
	...
	public ResponseEntity<Object> createTestParameterNumeric(@RequestBody Map<String, Object> inputMap)
			throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		final TestParameterNumeric objTestParameterNumeric = objMapper
				.convertValue(inputMap.get("testparameternumeric"), TestParameterNumeric.class);
		requestContext.setUserInfo(userInfo);
		// ALPD-4831,5873--Vignesh R(08-10-2024)--When nsettingcode 71 is set to 4, then
		// QualisLite= true and the Test Group is not required and is automatically
		// updated by default in the relevant test group-related tables.
	...
	public ResponseEntity<Object> updateTestParameterNumeric(@RequestBody Map<String, Object> inputMap)
			throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		final TestParameterNumeric objTestParameterNumeric = objMapper
	...
	public ResponseEntity<Object> deleteTestParameterNumeric(@RequestBody Map<String, Object> inputMap)
			throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		final TestParameterNumeric objTestParameterNumeric = objMapper
	...
	public ResponseEntity<Object> getParameterSpecificationById(@RequestBody Map<String, Object> objmap)
			throws Exception {
	...
	public ResponseEntity<Object> changeTestCatgoryInFormula(@RequestBody Map<String, Object> inputMap)
			throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		final int ntestCategoryCode = (int) inputMap.get("ntestcategorycode");
	...
	public ResponseEntity<Object> createTestFormula(@RequestBody Map<String, Object> inputMap) throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final TestFormula objTestFormula = objMapper.convertValue(inputMap.get("testformula"),
				new TypeReference<TestFormula>() {
				});
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		// ALPD-4831,5873--Vignesh R(08-10-2024)--When nsettingcode 71 is set to 4, then
		// QualisLite= true and the Test Group is not required and is automatically
	...
	public ResponseEntity<Object> calculateFormula(@RequestBody Map<String, Object> inputMap) throws Exception {
		...
		final List<DynamicField> lstDynamicField = mapper.convertValue(inputMap.get("dynamicformulafields"),
				new TypeReference<List<DynamicField>>() {
				});
		requestContext.setUserInfo(userInfo);
	...
	public ResponseEntity<Object> setDefaultTestPredefinedParameter(@RequestBody Map<String, Object> inputMap)
			throws Exception {
		final ObjectMapper objMapper=new ObjectMapper();
		final TestPredefinedParameter objTestPredefinedParameter = objMapper
				.convertValue(inputMap.get("testpredefinedparameter"), TestPredefinedParameter.class);
		...
		final int isQualisLite=(int)inputMap.get("isQualisLite");
		requestContext.setUserInfo(userInfo);
		return testParameterService.setDefaultTestPredefinedParameter(objTestPredefinedParameter, userInfo,
				isQualisLite);
	}
	...
	public ResponseEntity<Object> setDefaultTestInstrumentCategory(@RequestBody Map<String, Object> inputMap)
			throws Exception {
		final ObjectMapper objMapper=new ObjectMapper();
		final TestInstrumentCategory objTestInstrumentCategory = objMapper
				.convertValue(inputMap.get("testinstrumentcategory"), TestInstrumentCategory.class);
	...
	public ResponseEntity<Object> viewAttachedTestFile(@RequestBody Map<String, Object> inputMap,
	...
	public ResponseEntity<Object> createTestContainerType(@RequestBody Map<String, Object> inputMap) throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();	
		final TestContainerType objcreateTestContainerType = objMapper.convertValue(inputMap.get("testcontainertype"),
	...
	public ResponseEntity<Object> setDefaultTestContainerType(@RequestBody Map<String, Object> inputMap)
			throws Exception {
		final ObjectMapper objMapper=new ObjectMapper();
		final TestContainerType objTestContainerType = objMapper.convertValue(inputMap.get("testcontainertype"),
...
//	}
	...
	public ResponseEntity<Object> getAvailableContainerType(@RequestBody Map<String, Object> inputMap)
			throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class); 
		final TestMaster objTestMaster = objMapper.convertValue(inputMap.get("TestMaster"), TestMaster.class);
	...
	public ResponseEntity<Object> getActiveTestContainerTypeById(@RequestBody Map<String, Object> inputMap)
			throws Exception {
		final ObjectMapper objmapper = new ObjectMapper();
	...
	public ResponseEntity<Object> updateProjectReportInfo(@RequestBody Map<String, Object> inputMap) throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		final ReportInfoTest objReportInfoTest = objMapper.convertValue(inputMap.get("reportinfotest"),
				ReportInfoTest.class);
		requestContext.setUserInfo(userInfo);
	...
	public ResponseEntity<Object> createTestParameterClinicalSpec(@RequestBody Map<String, Object> inputMap)
			throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		final TestMasterClinicalSpec objTestParameterNumeric = objMapper
				.convertValue(inputMap.get("TestGroupAddSpecification"), TestMasterClinicalSpec.class);
		// ALPD-4831,5873--Vignesh R(08-10-2024)--When nsettingcode 71 is set to 4, then
		// QualisLite= true and the Test Group is not required and is automatically
		// updated by default in the relevant test group-related tables.
		final int isQualisLite=(int)inputMap.get("isQualisLite");
	...
	public ResponseEntity<Object> updateTestParameterClinicalSpec(@RequestBody Map<String, Object> inputMap)
			throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		final TestMasterClinicalSpec objTestParameterNumeric = objMapper
	...
	public ResponseEntity<Object> deleteTestParameterClinicalSpec(@RequestBody Map<String, Object> inputMap)
			throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		final TestMasterClinicalSpec objTestParameterNumeric = objMapper
				.convertValue(inputMap.get("testparameterclinicalspec"), TestMasterClinicalSpec.class);
		// ALPD-4831,5873--Vignesh R(08-10-2024)--When nsettingcode 71 is set to 4, then
		// QualisLite= true and the Test Group is not required and is automatically
		// updated by default in the relevant test group-related tables.
		final int isQualisLite=(int)inputMap.get("isQualisLite");
	...
	public ResponseEntity<Object> getTestParameterClinicalSpecById(@RequestBody Map<String, Object> objmap)
			throws Exception {
	...
	public ResponseEntity<Object> importData(MultipartHttpServletRequest request) throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.readValue(request.getParameter("userinfo"), UserInfo.class);
		
		requestContext.setUserInfo(userInfo);
		return testMasterService.importData(request, userInfo);
	}
	
	@PostMapping(value = "/getTestSubContractor")
	public ResponseEntity<Object> getTestSubContractor(@RequestBody Map<String, Object> inputMap) throws Exception {
		...
		requestContext.setUserInfo(userInfo);
		return testMasterService.getTestSubContractor(ntestcode, userInfo);
	}

	@PostMapping(value = "/getSubContractor")
	public ResponseEntity<Object> getSubContractor(@RequestBody Map<String, Object> inputMap) throws Exception {
		...
		requestContext.setUserInfo(userInfo);
		return testMasterService.getSubContractor(ntestcode, userInfo);
	}

	@PostMapping(value = "/createTestSubContractor")
	public ResponseEntity<Object> createTestSubContractor(@RequestBody Map<String, Object> inputMap) throws Exception {
		// try {
		ObjectMapper objMapper = new ObjectMapper();
		final TestSubContractor objTestSubContractor = objMapper.convertValue(inputMap.get("testsubcontractor"),
				new TypeReference<TestSubContractor>() {
				});
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);

		// final int isQualisLite=(int) inputMap.get("isQualisLite");
		requestContext.setUserInfo(userInfo);
		return testMasterService.createTestSubContractor(objTestSubContractor, userInfo);

	}

	@PostMapping(value = "/deleteTestSubContractor")
	public ResponseEntity<Object> deleteTestSubContractor(@RequestBody Map<String, Object> inputMap) throws Exception {

		ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		final TestSubContractor objTestSubContractor = objMapper.convertValue(inputMap.get("testsubcontractor"),
				TestSubContractor.class);
		...
		requestContext.setUserInfo(userInfo);
		return testMasterService.deleteTestSubContractor(objTestSubContractor, userInfo);
	}

	@PostMapping(value = "/setDefaultTestSubContractor")
	public ResponseEntity<Object> setDefaultTestSubContractor(@RequestBody Map<String, Object> inputMap)
			throws Exception {

		ObjectMapper objMapper = new ObjectMapper();
		final TestSubContractor objTestContainerType = objMapper.convertValue(inputMap.get("testsubcontractor"),
				TestSubContractor.class);
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		...
		// final int isQualisLite=(int)inputMap.get("isQualisLite");
		requestContext.setUserInfo(userInfo);
		return testMasterService.setDefaultTestSubContractor(objTestContainerType, userInfo);
	}
