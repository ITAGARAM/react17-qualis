...
//		}
	...
	//End
		...
		@PostMapping(value = "/getResultEntrySampleStatus")
		public ResponseEntity<Object> getResultEntrySampleStatus(@RequestBody Map<String, Object> inputMap)
				throws Exception {

			final ObjectMapper objMapper = new ObjectMapper();
			final UserInfo userInfo = objMapper.convertValue(inputMap.get("userInfo"), UserInfo.class);
			requestContext.setUserInfo(userInfo);
			return resultEntryService.getResultEntrySampleStatus(inputMap, userInfo);
		}
