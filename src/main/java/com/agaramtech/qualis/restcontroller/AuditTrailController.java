...
public class AuditTrailController {
	...
	public ResponseEntity<Object> getAuditTrailDetail(@RequestBody Map<String, Object> inputMap) throws Exception {
		...
		final int nviewArchivalTypeCode = (int) inputMap.get("viewArchivalTypeCode");
		...
		return auditTrailService.getAuditTrailByDate(userInfo, fromDate, toDate, nmodulecode, nformcode, nusercode,
				nuserrole, nviewtypecode, saudittraildate,nviewArchivalTypeCode);
	...
	public ResponseEntity<Object> getFilterAuditTrailRecords(@RequestBody Map<String, Object> inputMap)
		...
		return auditTrailService.getFilterAuditTrailRecords(userInfo, fromDate, toDate, nmodulecode, nformcode,
				nusercode, nuserrole, nviewtypecode,nviewarchivaltypecode);
	}
...
//			final UserInfo userInfo = objmapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
	...
	@PostMapping(value = "/createAuditArchival")
	public ResponseEntity<Object> createAuditArchival(@RequestBody Map<String, Object> inputMap)throws Exception {

		final ObjectMapper objmapper = new ObjectMapper();
		objmapper.registerModule(new JavaTimeModule());
		final AuditArchivalRecords audit = objmapper.convertValue(inputMap.get("auditarchival"), AuditArchivalRecords.class);
		
		final UserInfo userInfo = objmapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		requestContext.setUserInfo(userInfo);
		return auditTrailService.createAuditArchival(audit,userInfo);
		
	}
	
	@PostMapping(value = "/getAuditArchivalHistory")
	public ResponseEntity<Object> getAuditArchivalHistory(@RequestBody Map<String, Object> inputMap) throws Exception {
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), new TypeReference<UserInfo>() {});
		LOGGER.info("UserInfo:"+ userInfo);
		requestContext.setUserInfo(userInfo);
		return auditTrailService.getAuditArchivalHistory(userInfo);
	}
}