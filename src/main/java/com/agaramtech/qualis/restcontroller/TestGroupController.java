...
//				TestPredefinedSubcode.class);
	...
	@PostMapping(value = "/updateTestSorter")
	public ResponseEntity<Object> updateTestSorter(@RequestBody Map<String, Object> inputMap) throws Exception {
		
		ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"),new TypeReference<UserInfo>() {});
		requestContext.setUserInfo(userInfo);
		return objTestGroupService.updateTestSorter(inputMap,userInfo);
	}
	
	@PostMapping(value = "/getTestGroupParameter")
	public ResponseEntity<Object> getTestGroupParameter(@RequestBody Map<String, Object> inputMap) throws Exception {
		
		ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"),new TypeReference<UserInfo>() {});
		requestContext.setUserInfo(userInfo);
		return objTestGroupService.getTestGroupParameter(inputMap,userInfo);
	}
	
	@PostMapping(value = "/updateTestParameterSorter")
	public ResponseEntity<Object> updateTestParameterSorter(@RequestBody Map<String, Object> inputMap) throws Exception {
		
		ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"),new TypeReference<UserInfo>() {});
		requestContext.setUserInfo(userInfo);
		return objTestGroupService.updateTestParameterSorter(inputMap,userInfo);
	}
