...
public class ContainerTypeController {
	...
	public ContainerTypeController(final ContainerTypeService containerTypeService, final RequestContext requestContext) {
		super();
	...
	public ResponseEntity<Object> getContainerType(@RequestBody final Map<String, Object> inputMap) throws Exception {
		LOGGER.info("In getContainerType endpoint");
		final ObjectMapper objMapper = new ObjectMapper();
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), new TypeReference<UserInfo>() {
		});
		requestContext.setUserInfo(userInfo);
		return containerTypeService.getContainerType(userInfo);
	}
	...
	public ResponseEntity<Object> createContainerType(@RequestBody final Map<String, Object> inputMap) throws Exception {
		final ObjectMapper objmapper = new ObjectMapper();
	...
	public ResponseEntity<Object> updateContainerType(@RequestBody final Map<String, Object> inputMap) throws Exception {
		final ObjectMapper objmapper = new ObjectMapper();
	...
	public ResponseEntity<Object> getActiveContainerTypeById(@RequestBody final Map<String, Object> inputMap)
			throws Exception {
		final ObjectMapper objmapper = new ObjectMapper();
	...
	public ResponseEntity<Object> deleteContainerType(@RequestBody final Map<String, Object> inputMap) throws Exception {
		final ObjectMapper objmapper = new ObjectMapper();
		objmapper.registerModule(new JavaTimeModule());
		final ContainerType containerType = objmapper.convertValue(inputMap.get("containertype"), ContainerType.class);
		final UserInfo userInfo = objmapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
