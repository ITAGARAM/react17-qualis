...
public class SupplierCategoryController {
	 ...
	 * @return response entity of deleted suppliercategory entity
	 */
	@PostMapping(value = "/getSupplierType")
	public ResponseEntity<Object> getSupplierType(@RequestBody Map<String, Object> inputMap) throws Exception {
		...
		return suppliercategoryService.getSupplierType(inputMap, userInfo);
	}
