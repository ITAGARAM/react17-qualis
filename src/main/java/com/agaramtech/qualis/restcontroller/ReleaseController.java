...
public class ReleaseController {
	...
	public ResponseEntity<Object> sendReportByMail(@RequestBody Map<String, Object> inputMap) throws Exception {
		...
		final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
		requestContext.setUserInfo(userInfo);
		return releaseService.sendReportByMail(inputMap, userInfo);
	}
	...
	// ALPDJ21-69--Added by Vignesh(02-09-2025)--Test wise release
			 ...
			 * @throws Exception exception
			 */
		@PostMapping(value = "/getReleseTestStatus")
		public ResponseEntity<Object> getReleseTestStatus(@RequestBody Map<String, Object> inputMap) throws Exception {
			final ObjectMapper objMapper = new ObjectMapper();
			final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
			requestContext.setUserInfo(userInfo);
			return releaseService.getReleseTestStatus(userInfo);
		}
		...
		// ALPDJ21-69--Added by Vignesh(02-09-2025)--Test wise release
				 ...
				 */
				@PostMapping(value = "/getRelaseTestFilter")
				public ResponseEntity<Object> getRelaseTestFilter(@RequestBody Map<String, Object> inputMap) throws Exception {
					final ObjectMapper objMapper = new ObjectMapper();
					final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
					requestContext.setUserInfo(userInfo);
					return releaseService.getRelaseTestFilter(userInfo);
				}
				
			     //ALPDJ21-93--Added by Vignesh(30-10-2025)-->Release and report screen -> HL7 Format Conversion
				@PostMapping(value = "/uploadInHL7Format")
				public ResponseEntity<Object> uploadInHL7Format(@RequestBody Map<String, Object> inputMap) throws Exception {
					final ObjectMapper objMapper = new ObjectMapper();
					final UserInfo userInfo = objMapper.convertValue(inputMap.get("userinfo"), UserInfo.class);
					requestContext.setUserInfo(userInfo);
					return releaseService.uploadInHL7Format(inputMap,userInfo);
				}
}