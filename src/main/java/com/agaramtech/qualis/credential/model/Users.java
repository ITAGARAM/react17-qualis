...
public class Users extends CustomizedResultsetRowMapper<Users> implements Serializable, RowMapper<Users> {
	...
	//Added by sonia on 16th August 2025 for jira id:SWSM-6
	@Transient
	private transient int ndeptheadcode;
	@Transient
	...
	public Users mapRow(ResultSet arg0, int arg1) throws SQLException {
		...
		objUsers.setNdeptheadcode(getInteger(arg0, "ndeptheadcode", arg1)); //Added by sonia on 16th August 2025 for jira id:SWSM-6
		objUsers.setSdeptheadname(getString(arg0, "sdeptheadname", arg1)); //Added by sonia on 16th August 2025 for jira id:SWSM-6
		return objUsers;
	}
