...
public class ControlMaster extends CustomizedResultsetRowMapper<ControlMaster> implements Serializable, RowMapper<ControlMaster> {
	...
	@ColumnDefault("4")
	@Column(name = "nneedemailotp", nullable = false)
	private short nneedemailotp = (short)Enumeration.TransactionStatus.NO.gettransactionstatus();
	...
	public ControlMaster mapRow(ResultSet arg0, int arg1) throws SQLException {
		...
		objControlMaster.setNneedemailotp(getShort(arg0, "nneedemailotp", arg1));
