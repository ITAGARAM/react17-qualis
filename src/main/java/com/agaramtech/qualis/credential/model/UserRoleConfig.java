...
public class UserRoleConfig extends CustomizedResultsetRowMapper<UserRoleConfig> implements Serializable, RowMapper<UserRoleConfig> {
	...
	@ColumnDefault("4")
	@Column(name = "nneedtechnicianflow", nullable = false)
	private short nneedtechnicianflow = (short)Enumeration.TransactionStatus.NO.gettransactionstatus();
	
	@ColumnDefault("4")
	@Column(name = "nneedprojectinvestigatorflow", nullable = false)
	private short nneedprojectinvestigatorflow = (short)Enumeration.TransactionStatus.NO.gettransactionstatus();
	
	@ColumnDefault("4")
	@Column(name = "nneedthirdpartyflow", nullable = false)
	private short nneedthirdpartyflow = (short)Enumeration.TransactionStatus.NO.gettransactionstatus();
	
	// added by sujatha ATE_274 for NGS column
	@ColumnDefault("4")
	@Column(name = "nneedngsflow", nullable = false)
	private short nneedngsflow = (short)Enumeration.TransactionStatus.NO.gettransactionstatus();
	...
	@Transient
	private transient int nuserroleconfigtypecode;
	

	@Override
	public UserRoleConfig mapRow(final ResultSet arg0,final int arg1) throws SQLException {
		...
		objUserRoleConfig.setNneedtechnicianflow(getShort(arg0,"nneedtechnicianflow",arg1));
		objUserRoleConfig.setNneedprojectinvestigatorflow(getShort(arg0,"nneedprojectinvestigatorflow",arg1));
		objUserRoleConfig.setNneedthirdpartyflow(getShort(arg0,"nneedthirdpartyflow",arg1));
		objUserRoleConfig.setNuserroleconfigtypecode(getInteger(arg0, "nuserroleconfigtypecode", arg1));
		// added by sujatha ATE_274 for NGS Column
		objUserRoleConfig.setNneedngsflow(getShort(arg0,"nneedngsflow",arg1));
