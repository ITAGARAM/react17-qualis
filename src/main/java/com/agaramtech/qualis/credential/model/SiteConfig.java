...
public class SiteConfig extends CustomizedResultsetRowMapper<SiteConfig> implements Serializable, RowMapper<SiteConfig> {
	...
	@ColumnDefault("-1")
	@Column(name = "ninputtimezonecode", nullable = false)
	private short ninputtimezonecode = (short) Enumeration.TransactionStatus.NA.gettransactionstatus();
	...
	public SiteConfig mapRow(ResultSet arg0, int arg1) throws SQLException {
		...
		objSiteConfig.setNinputtimezonecode(getShort(arg0, "ninputtimezonecode", arg1)); //Added by sonia on 18th July 2025 for jira id:ALPDJ21-18
