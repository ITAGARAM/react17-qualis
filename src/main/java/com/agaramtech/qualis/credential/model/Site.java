...
public class Site extends CustomizedResultsetRowMapper<Site> implements Serializable, RowMapper<Site> {
	...
	@Transient
	private transient String sbiobanksitename;
	
	@Transient
	private transient String sinputtimezoneid;
	...
	public Site mapRow(ResultSet arg0, int arg1) throws SQLException {
		...
		objSite.setNbiobanksitecode(getInteger(arg0, "nbiobanksitecode", arg1));
		objSite.setSbiobanksitename(getString(arg0, "sbiobanksitename", arg1));
		objSite.setSinputtimezoneid(getString(arg0, "sinputtimezoneid", arg1));
		objSite.setNinputtimezonecode(getShort(arg0, "ninputtimezonecode", arg1));
