...
/**
 * This interface holds declarations to perform CRUD operation on 'outsourceemployee' table
 */
/**
...
public interface ManPowerDAO {
	...
	/**
	 * This interface declaration is used to get all the available outsourceemployee's with
	 * respect to site
	 * 
	...
	/**
	 * This interface declaration is used to add a new entry to outsourceemployee table.
	 * 
	...
	/**
	 * This interface declaration is used to retrieve active manpower object based
	 * on the specified nmanpowercode.
	 * 
	...
	/**
	 * This interface declaration is used to update entry in outsourceemployee table.
	 * 
	...
	/**
	 * This interface declaration is used to delete an entry in outsourceemployee table.
	 * 
