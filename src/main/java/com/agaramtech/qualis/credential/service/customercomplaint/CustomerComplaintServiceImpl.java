...
/**
 * This class holds methods to perform CRUD operation on 'customercomplaint'
...
public class CustomerComplaintServiceImpl implements CustomerComplaintService {
	 ...
	 * 
	 * @param customerComplaintDAO customerComplaintDAO Interface
	 * @param commonFunction       CommonFunction holding common utility functions
	 */
	public CustomerComplaintServiceImpl(CustomerComplaintDAO customerComplaintDAO, CommonFunction commonFunction) {
	 ...
	 * retrieve all available customercomplaint for a specific site.
	 *
	...
	public ResponseEntity<Object> getCustomerComplaint(final Map<String, Object> inputMap, final UserInfo userInfo)
		...
		return customerComplaintDAO.getCustomerComplaint(inputMap, userInfo);
	}

	/**
	 * This service implementation method provides access to the DAO layer to
	 * retrieve all available customercomplaint for a specific site, filtered by
	...
	public ResponseEntity<Object> getCustomerComplaintData(final Map<String, Object> inputMap, final UserInfo userInfo)
		...
		return customerComplaintDAO.getCustomerComplaintData(inputMap, userInfo);
	}
	...
	public ResponseEntity<Object> getRegion(final UserInfo userInfo) throws Exception {
		return customerComplaintDAO.getRegion(userInfo);
	...
	public ResponseEntity<Object> getDistrict(final int nregioncode,
		...
		return customerComplaintDAO.getDistrict(nregioncode, userInfo);
	}
	...
	public ResponseEntity<Object> getCity(final int ndistrictcode, final UserInfo userInfo)
		...
		return customerComplaintDAO.getCity(ndistrictcode, userInfo);
	}
	...
	public ResponseEntity<Object> getVillage(final int nsitehierarchyconfigcode, final int ncitycode, final UserInfo userInfo)
		...
		return customerComplaintDAO.getVillage(nsitehierarchyconfigcode, ncitycode, userInfo);
	}

	/**
	 * Service interface method to mark a record as initiated in the
	...
	public ResponseEntity<Object> initiateCustomerComplaint(Map<String, Object> objmap) throws Exception {
		return customerComplaintDAO.initiateCustomerComplaint(objmap);
	}
	...
	public ResponseEntity<Object> closeCustomerComplaint(Map<String, Object> objmap) throws Exception {
		return customerComplaintDAO.closeCustomerComplaint(objmap);
	}

	/**
	 * This service implementation declaration is responsible for creating a new
	 * CustomerComplaint record by accessing the DAO layer.
	 * 
	...
	public ResponseEntity<Object> createCustomerComplaint(Map<String, Object> objmap) throws Exception {
		return customerComplaintDAO.createCustomerComplaint(objmap);
	}

	/**
	 * This service implementation declaration will access the DAO layer that is
	 * used to retrieve active customercomplainthistory object based on the
	 * specified ncustomercomplaintode.
	 * 
	 ...
	 */
	@Override
	public ResponseEntity<Object> getActiveCustomerComplaintById(final int ncustomercomplaintcode,
			final UserInfo userInfo) throws Exception {

		final CustomerComplaint customerComplaint = customerComplaintDAO
				.getActiveCustomerComplaintById(ncustomercomplaintcode, userInfo);
	...
	/**
	 * This service implementation declaration will access the DAO layer that is
	 * used to update entry in customercomplaint table.
	 * 
	...
	public ResponseEntity<Object> updateCustomerComplaint(Map<String, Object> objMap) throws Exception {
		return customerComplaintDAO.updateCustomerComplaint(objMap);
	}

	/**
	 * This service implementation declaration will access the DAO layer that is
	 * used to delete an entry in customercomplaint table.
	 * 
	 * @param inputMap holding the date fromDate,toDate,Status customercomplaint
	 *                 details and userInfo [UserInfo] holding logged in user
	 *                 details and nmasterSiteCode [int] primary key of site object
	...
	public ResponseEntity<Object> deleteCustomerComplaint(Map<String, Object> objMap) throws Exception {
		return customerComplaintDAO.deleteCustomerComplaint(objMap);
	}
	...
	public ResponseEntity<Object> getCustomerComplaintRecord(final int ncustomercomplaintcode, final UserInfo userInfo)
			throws Exception {
		return customerComplaintDAO.getCustomerComplaintRecord(ncustomercomplaintcode, userInfo);
	...
	/**
	 * This service implementation declaration will access the DAO layer that is
	 * used to create the records in customercomplaintfile
	 * 
	...
	public ResponseEntity<Object> createCustomerComplaintFile(MultipartHttpServletRequest request,
		...
		return customerComplaintDAO.createCustomerComplaintFile(request, objUserInfo);
	}
	...
	public ResponseEntity<Object> editCustomerComplaintFile(final CustomerComplaintFile objCustomerComplaintFile,
		...
		return customerComplaintDAO.editCustomerComplaintFile(objCustomerComplaintFile, objUserInfo);
	}
	...
	public ResponseEntity<Object> deleteCustomerComplaintFile(final CustomerComplaintFile objCustomerComplaintFile,
			final UserInfo objUserInfo) throws Exception {
		return customerComplaintDAO.deleteCustomerComplaintFile(objCustomerComplaintFile, objUserInfo);
	}
	...
	public ResponseEntity<Object> updateCustomerComplaintFile(MultipartHttpServletRequest request,
			final UserInfo objUserInfo) throws Exception {
		return customerComplaintDAO.updateCustomerComplaintFile(request, objUserInfo);
	}
	...
	public ResponseEntity<Object> viewAttachedCustomerComplaintFile(CustomerComplaintFile objCustomerComplaintFile,
			UserInfo objUserInfo) throws Exception {
		return customerComplaintDAO.viewAttachedCustomerComplaintFile(objCustomerComplaintFile, objUserInfo);
	}
