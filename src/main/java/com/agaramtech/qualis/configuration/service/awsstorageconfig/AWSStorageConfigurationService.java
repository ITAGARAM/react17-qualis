...
/**
 * This interface declaration holds methods to perform CRUD operation on 'AWSStorageConfig' table
 */
public interface AWSStorageConfigurationService {
	 ...
	 * @throws Exception that are thrown from this DAO layer
     */
	public ResponseEntity<Object> getActiveAWSStorageConfigById(final int nawsstorageconfigcode,final UserInfo userInfo) throws Exception;
