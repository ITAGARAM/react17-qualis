...
public class InterfacerMappingDAOImpl implements InterfacerMappingDAO {
	 ...
	 */
	//ATE-234 janakumar ALPD-6084 Interfacer Mapping --> While add interfacer mapping 500 occurs
	private InterfacerMapping getInterfacerByName(int ninterfacetypecode, short nsitecode, String Stestname) throws Exception {
