...
/**
 * This class holds methods to perform CRUD operation on 'AWSStorageConfig' table through its DAO layer.
 */
public class AWSStorageConfigurationServiceimpl implements AWSStorageConfigurationService {
	private final AWSStorageConfigurationDAO objAWSStorageConfigurationDAO;
	private final CommonFunction commonFunction;

	/**
	 * This constructor injection method is used to pass the object dependencies to the class properties.
	 * @param objAWSStorageConfigurationDAO AWSStorageConfigurationDAO Interface
	 * @param commonFunction CommonFunction holding common utility functions
	 */
	public AWSStorageConfigurationServiceimpl(AWSStorageConfigurationDAO objAWSStorageConfigurationDAO, CommonFunction commonFunction) {
		this.objAWSStorageConfigurationDAO = objAWSStorageConfigurationDAO;
	...
	public ResponseEntity<Object> getAWSStorageConfig(final UserInfo userInfo) throws Exception {
		...
		return objAWSStorageConfigurationDAO.getAWSStorageConfig(userInfo);
	}
	...
	public ResponseEntity<Object> createAWSStorageConfig(AWSStorageConfig awsStorageConfig,final UserInfo userInfo) throws Exception {
		// TODO Auto-generated method stub
		return objAWSStorageConfigurationDAO.createAWSStorageConfig(awsStorageConfig, userInfo);
	}
	...
	public ResponseEntity<Object> updateAWSStorageConfig(AWSStorageConfig awsStorageConfig,final UserInfo userInfo) throws Exception {
		// TODO Auto-generated method stub
		return objAWSStorageConfigurationDAO.updateAWSStorageConfig(awsStorageConfig, userInfo);
	}
	...
	public ResponseEntity<Object> deleteAWSStorageConfig(AWSStorageConfig awsStorageConfig,final UserInfo userInfo) throws Exception {
		// TODO Auto-generated method stub
		return objAWSStorageConfigurationDAO.deleteAWSStorageConfig(awsStorageConfig, userInfo);
	}
     ...
     */
	@Override
	public ResponseEntity<Object> getActiveAWSStorageConfigById(int nawsstorageconfigcode,final  UserInfo userInfo)
			throws Exception {
		// TODO Auto-generated method stub
		final AWSStorageConfig awsStorageConfig=objAWSStorageConfigurationDAO.getActiveAWSStorageConfigById(nawsstorageconfigcode, userInfo);
		if (awsStorageConfig == null) {
			return new ResponseEntity<>(
					commonFunction.getMultilingualMessage(Enumeration.ReturnStatus.ALREADYDELETED.getreturnstatus(),
							userInfo.getSlanguagefilename()),
					HttpStatus.EXPECTATION_FAILED);
		} else {
			return new ResponseEntity<>(awsStorageConfig, HttpStatus.OK);
		}
	}
