...
public class LicenseConfiguration extends CustomizedResultsetRowMapper<LicenseConfiguration> implements Serializable, RowMapper<LicenseConfiguration> {
	...
	// Added by Ganesh - Subscription Based Validation - 09/10/2025
	@Column(name = "sstartdatetime")
	private String sstartdatetime;
	
	@Column(name = "senddatetime")
	private String senddatetime;
	
	@Column(name = "nreminderduration")	
	private int nreminderduration;
	
	@Column(name = "nreminderperiod")	
	private int nreminderperiod;
	...
	public LicenseConfiguration mapRow(ResultSet arg0, int arg1) throws SQLException {
		...
		//Added by Ganesh - Subscription Based Validation - 09/10/2025
		objLicenseConfiguration.setSstartdatetime(getString(arg0,"sstartdatetime",arg1));
		objLicenseConfiguration.setSenddatetime(getString(arg0,"senddatetime", arg1));
		objLicenseConfiguration.setNreminderduration(getInteger(arg0,"nreminderduration", arg1));
		objLicenseConfiguration.setNreminderperiod(getInteger(arg0,"nreminderperiod", arg1));
