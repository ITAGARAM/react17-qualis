...
public interface AuditCategoryService {
	 ...
	 * get all the available auditcategory's with respect to site
	 * 
	 * @param userInfo [UserInfo] holding logged in user details and nmasterSiteCode
	 *                 [int] primary key of site object for which the list is to be
	 *                 fetched
	 * @return a response entity which holds the list of auditcategory records
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> getActiveAuditCategoryById(final int nauditcategorycode,
	 ...
	 * 
	 * @param objAuditCategory [AuditCategory] object holding details to be
	 *                           added in auditcategory table
	 ...
	 * 
	 * @param objAuditCategory [AuditCategory] object holding details to be
	 *                           updated in auditcategory table
	 * @param userInfo           [UserInfo] holding logged in user details and
	 *                           nmasterSiteCode [int] primary key of site object
	 *                           for which the list is to be fetched
	 ...
	 * 
	 * @param objAuditCategory [AuditCategory] object holding detail to be
	 *                           deleted from auditcategory table
	 * @param userInfo           [UserInfo] holding logged in user details and
	 *                           nmasterSiteCode [int] primary key of site object
	 *                           for which the list is to be fetched
