...
/**
 * This interface declaration holds methods to perform CRUD operation on 'auditplan','auditplanhistory','auditplanmembers','auditplanauditors' table
 */
/**
...
public interface AuditPlanService {
	...
	/**
	 * This service interface declaration will access the DAO layer calls the getFilterStatus and getAuditPlanData methods and that is used 
	...
	/**
	 * This service interface declaration will access the DAO layer that is used to retrieve active auditplan object based
	...
	/**
	 * This service interface declaration will access the DAO layer that is used to delete an entry in auditplan table.
	...
	/**
	 * This service interface declaration will access the DAO layer that is used to retrieve list of Audit Date & Time,Scheduled,Rescheduled,Closed based on the transaction status. 
	...
	/**
	 * This service interface declaration will access the DAO layer that is used to make a new entry to "auditplanhistory" table and to update selected auditplan table .
	 * @param objAuditPlan [AuditPlan] object holding details to be updated in auditplan table
	 * @param userInfo [UserInfo] holding logged in user details and nmasterSiteCode [int] primary key of site object for 
	 * 							  which the list is to be fetched
	 * @return response entity object holding response status and data of updated auditplan object
	...
	/**
	 * This service interface declaration will access the DAO layer that is used to delete an entry in auditplanmembers table.
	...
	/**
	 * This service interface declaration will access the DAO layer that is used to delete an entry in auditplanauditors table.
	...
	/**
	 * This service interface declaration will access the DAO layer that is used to retrieve active auditplanfile object based
	...
	/**
	 * This service interface declaration will access the DAO layer that is used to delete an entry in auditplanfile table.
	...
	/**
	 * This service interface declaration will access the DAO layer that is used to fetch a file/ link which need to view
