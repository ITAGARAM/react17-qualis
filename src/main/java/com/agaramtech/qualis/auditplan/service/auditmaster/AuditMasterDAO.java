...
/**
 * This interface holds declarations to perform CRUD operation on 'auditmaster' table
 */
/**
* @author AT-E143 SWSM-2 22/07/2025
*/
public interface AuditMasterDAO {
	/**
	 * This interface declaration is used to get all the available auditmaster with respect to site
	...
	/**
	 * This interface declaration is used to retrieve active auditmaster object based
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public AuditMaster getActiveAuditMasterById(final int nauditMasterCode,UserInfo userInfo) throws Exception;		
	/**
	 * This interface declaration is used to add a new entry to auditmaster  table.
	...
	/**
	 * This interface declaration is used to update entry in auditmaster  table.
	...
	/**
	 * This interface declaration is used to delete an entry in auditmaster  table.
