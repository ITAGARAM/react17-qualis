...
public interface BioEcatalogueReqApprovalDAO {
	...
	public ResponseEntity<Object> getSelectedBioEcatalogueReqApproval(int nrequestapprovlcode, int ntransfertype,
			int ntransactionstatus, UserInfo userInfo) throws Exception;
