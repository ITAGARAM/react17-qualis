...
public interface BioThirdPartyFormAcceptanceService {
...
//			throws Exception;
	...
	public ResponseEntity<Object> moveToReturnSamplesAfterComplete(final int nbioThirdPartyFormAcceptanceCode,
			final String nbioThirdPartyFormAcceptanceDetailsCode, final UserInfo userInfo) throws Exception;
