 ...
 */
public interface SampleCodeCreationDAO {
	/**
	 ...
	 * object based on the specified nsamplecodecreationcode.
	 * 
	 ...
	 */
	public SampleCodeCreation getActiveSampleCodeCreationById(final int nsamplecodecreationcode,final
