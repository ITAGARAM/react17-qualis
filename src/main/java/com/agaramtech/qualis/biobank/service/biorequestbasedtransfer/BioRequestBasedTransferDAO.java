...
public interface BioRequestBasedTransferDAO {
	...
	public ResponseEntity<Object> createChildBioRequestBasedTransfer(Map<String, Object> inputMap, UserInfo userInfo)
			throws Exception;
	...
	public int findStatusRequestBasedtTransfer(int nbioRequestBasedCode, UserInfo userInfo) throws Exception;
