...
public interface ProcessedSampleReceivingDAO {

	
	public ResponseEntity<Object> getProcessedSampleReceiving(final Map<String, Object> inputMap, final UserInfo userInfo) throws Exception;
	...
	public ResponseEntity<Map<String, Object>> getActiveSampleCollection(Map<String, Object> inputMap, UserInfo userInfo) throws Exception;
