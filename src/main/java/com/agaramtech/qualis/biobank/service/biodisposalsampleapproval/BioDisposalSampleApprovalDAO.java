...
public interface BioDisposalSampleApprovalDAO {

	public ResponseEntity<Object> getDisposalSampleApproval(Map<String, Object> inputMap, UserInfo userInfo)
			throws Exception;

	public List<Map<String, Object>> getChildInitialGet(int nbiorequestbasedtransfercode, UserInfo userInfo)
			throws Exception;

	public List<Map<String, Object>> completeDisposalSamplesApproval(Map<String, Object> inputMap, UserInfo userInfo)
			throws Exception;
