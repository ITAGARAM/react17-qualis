...
/**
 * Maps to 'biobgsiecataloguehistory' table.
 */
@Entity
@Table(name = "biobgsiecataloguehistory")
@Data
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(callSuper = false)
public class BioBGSiECatalogueHistory extends CustomizedResultsetRowMapper<BioBGSiECatalogueHistory>
        implements Serializable, RowMapper<BioBGSiECatalogueHistory> {

    private static final long serialVersionUID = 1L;

    @Id
    @Column(name = "nbiobgsiecataloguehistorycode", nullable = false)
    private int nbiobgsiecataloguehistorycode;
    ...
    @Override
    public BioBGSiECatalogueHistory mapRow(ResultSet rs, int rowNum) throws SQLException {
        BioBGSiECatalogueHistory obj = new BioBGSiECatalogueHistory();
        obj.setNbiobgsiecataloguehistorycode(getInteger(rs, "nbiobgsiecataloguehistorycode", rowNum));
