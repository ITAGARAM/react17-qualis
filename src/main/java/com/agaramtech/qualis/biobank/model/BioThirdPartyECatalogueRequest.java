...
/**
 * Maps to 'biothirdpartyecataloguerequest' table.
 */
@Entity
@Table(name = "biothirdpartyecataloguerequest")
@Data
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(callSuper = false)
public class BioThirdPartyECatalogueRequest extends CustomizedResultsetRowMapper<BioThirdPartyECatalogueRequest>
		implements Serializable, RowMapper<BioThirdPartyECatalogueRequest> {
	...
	@Transient
	private transient String srequesteddate;
	@Transient
	private transient String stransactiondate;
	@Transient
	private transient String sprojecttitles;
	@Transient
	private transient String scolorhexcode;
	@Transient
	private transient String sreqformtypename;

	@Override
	public BioThirdPartyECatalogueRequest mapRow(ResultSet rs, int rowNum) throws SQLException {
		BioThirdPartyECatalogueRequest obj = new BioThirdPartyECatalogueRequest();
		obj.setNthirdpartyecatrequestcode(getInteger(rs, "nthirdpartyecatrequestcode", rowNum));
		obj.setNthirdpartycode(getInteger(rs, "nthirdpartycode", rowNum));
