...
//End
   ...
   /**
	 ...
	 * @throws Exception
	 */
	public ResponseEntity<Object> getTestInstrumentCategory(Map<String, Object> inputMap, UserInfo userInfo) throws Exception;
	
	/**
	 * This interface declaration is used to update entry in registration test table.
	 * @param inputMap [Map] object holding details to be updated in registrationtest table
	 * @return response entity object holding response status and data of updated method object
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> updateTestInstrumentCategory(Map<String, Object> inputMap, UserInfo userInfo) throws Exception;
	//end
	
	public ResponseEntity<Object> getTestPackage(Map<String, Object> inputMap, UserInfo userInfo) throws Exception;
	
	public ResponseEntity<Object> getSubSampleBasedOnTestPackage(Map<String, Object> inputMap, UserInfo userInfo) throws Exception;

	public ResponseEntity<Object> getRegistrationSentToStore(Map<String, Object> inputMap, UserInfo userInfo)throws Exception;

	public ResponseEntity<Object> getRegistrationSampleStatus(Map<String, Object> inputMap, UserInfo userInfo)throws Exception;
	...
	//ALPDJ21-110--Added by Vignesh(29-09-2025)-->Test Package tab added in Sample Registration Screen.
		 ...
		 * @throws Exception
		 */
	public ResponseEntity<Map<String,Object>> getTestPackageBySample(final String spreregno, UserInfo userInfo)throws Exception;
