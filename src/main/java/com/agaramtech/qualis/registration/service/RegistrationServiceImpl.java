...
//	
	...
	//Added by Vignesh R(06-08-2025) for JIRA ID:ALPDJ21-49 edit test instrument category insert 
	//Start
	/**
	 * This Method is used to get the over all instrumentcategory with respect to test
	 * 
	 ...
	 */
	@Override
	public ResponseEntity<Object> getTestInstrumentCategory(Map<String, Object> inputMap, UserInfo userInfo)
			throws Exception {
		return registrationDAO.getTestInstrumentCategory(inputMap, userInfo);
	}
	/**
	 * This interface declaration is used to update entry in registrationtest table.
	 * @param inputMap [Map] object holding details to be updated in registrationtest table
	 * @return response entity object holding response status and data of updated method object
	 * @throws Exception
	 */
	@Override
	public ResponseEntity<Object> updateTestInstrumentCategory(Map<String, Object> inputMap, UserInfo userInfo)
			throws Exception {
		return registrationDAO.updateTestInstrumentCategory(inputMap, userInfo);
	}
	//end
	
	@Override
	public ResponseEntity<Object> getTestPackage(Map<String, Object> inputMap, UserInfo userInfo)
			throws Exception {
		return registrationDAO.getTestPackage(inputMap, userInfo);
	}
	
	@Override
	public ResponseEntity<Object> getSubSampleBasedOnTestPackage(Map<String, Object> inputMap, UserInfo userInfo)
			throws Exception {
		return registrationDAO.getSubSampleBasedOnTestPackage(inputMap, userInfo);
	}
	...
	public ResponseEntity<Object> getRegistrationSentToStore(Map<String, Object> inputMap, UserInfo userInfo)
			throws Exception {
		// TODO Auto-generated method stub
		return registrationDAO.getRegistrationSentToStore(inputMap, userInfo);
	...
	public ResponseEntity<Object> getRegistrationSampleStatus(Map<String, Object> inputMap, UserInfo userInfo)
			throws Exception {
		// TODO Auto-generated method stub
		return registrationDAO.getRegistrationSampleStatus(inputMap, userInfo);
	}
	...
	public ResponseEntity<Map<String,Object>> getTestPackageBySample(final String spreregno, UserInfo userInfo)
			throws Exception {
		// TODO Auto-generated method stub
		return registrationDAO.getTestPackageBySample(spreregno, userInfo);
	}
}
