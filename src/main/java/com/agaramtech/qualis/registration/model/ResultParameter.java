...
public class ResultParameter extends CustomizedResultsetRowMapper<ResultParameter> implements Serializable, RowMapper<ResultParameter> {
	...
	@Transient
	private transient String sapprovemin;
	
	@Transient
	private transient String sapprovemax;
	...
	public ResultParameter mapRow(ResultSet arg0, int arg1) throws SQLException {
		...
		resultParameter.setSapprovemin(getString(arg0,"sapprovemin", arg1));
		resultParameter.setSapprovemax(getString(arg0,"sapprovemax", arg1));
		resultParameter.setSresultpredefinedname(getString(arg0,"sresultpredefinedname", arg1));
