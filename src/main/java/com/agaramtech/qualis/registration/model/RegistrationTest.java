...
public class RegistrationTest  extends CustomizedResultsetRowMapper<RegistrationTest> implements Serializable,RowMapper<RegistrationTest> {
	...
	private int ntestpackagetestcode =Enumeration.TransactionStatus.NA.gettransactionstatus();	
	...
	@Transient
	private transient int ntrainingneed;
	...
	public RegistrationTest mapRow(ResultSet arg0, int arg1) throws SQLException {
		...
		objRegistrationTest.setNtestpackagetestcode(getInteger(arg0,"ntestpackagetestcode",arg1));
		objRegistrationTest.setNtrainingneed(getInteger(arg0,"ntrainingneed",arg1)); //Added by sonia on 28th August 2025 for jira id:SWSM-15
		objRegistrationTest.setNtestpackagecode(getInteger(arg0,"ntestpackagecode",arg1));
