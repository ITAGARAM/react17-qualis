...
public class CourierDAOImpl implements CourierDAO {
	...
	public ResponseEntity<Object> deleteCourier(Courier courier, UserInfo userInfo) throws Exception {
		...
		if (courierbyID == null) {
			...
			final String query = "select 'IDS_GOODSIN' as Msg from goodsin where ncouriercode="+ courier.getNcouriercode() + " and nstatus="
					             + Enumeration.TransactionStatus.ACTIVE.gettransactionstatus()
								+ " union all"
								+ " select 'IDS_DIRECTTRANSFER' as Msg from biodirecttransfer where ncouriercode= " + courier.getNcouriercode()+" "
