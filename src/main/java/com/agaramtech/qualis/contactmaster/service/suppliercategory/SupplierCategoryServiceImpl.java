...
public class SupplierCategoryServiceImpl implements SupplierCategoryService {
	...
	@Override
	public ResponseEntity<Object> getSupplierType(Map<String, Object> inputMap, UserInfo userInfo) throws Exception {
		// TODO Auto-generated method stub
		return suppliercategoryDAO.getSupplierType(inputMap, userInfo);
	}
