...
public class COAParent extends CustomizedResultsetRowMapper<COAParent> implements Serializable, RowMapper<COAParent> {
	...
	@Transient
	private transient String spatientid;
	
	@Override
	public COAParent mapRow(ResultSet arg0, int arg1) throws SQLException {

		final COAParent objCOAParent = new COAParent();
		...
		objCOAParent.setSarno(getString(arg0, "sarno", arg1));
		objCOAParent.setSsamplearno(getString(arg0, "ssamplearno", arg1));
		objCOAParent.setSproductname(getString(arg0, "sproductname", arg1));
		objCOAParent.setSexternalorderid(getString(arg0, "sexternalorderid", arg1));
		objCOAParent.setSpatientid(getString(arg0, "spatientid", arg1));
