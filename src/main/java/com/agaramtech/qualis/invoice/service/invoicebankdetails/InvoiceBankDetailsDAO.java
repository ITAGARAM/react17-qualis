 ...
 */
public interface InvoiceBankDetailsDAO {

	/**
	 * This interface declaration is used to get all the available BankDetails with
	 * respect to site
	 * 
	 ...
	 * details in database. Need to check for duplicate entry of bankdetails name
	 * for the specified site before saving into database. Need to check that there
	 * should be only one default InvoiceBankDetails for a site
	 * 
