...
@Service
public class InvoiceCustomerMasterServiceImpl implements InvoiceCustomerMasterService {

	@Autowired
	private InvoiceCustomerMasterDAO invoiceCustomerMasterDAO;
	 /**
	...
	public ResponseEntity<Object> getInvoiceCustomerMaster(UserInfo userInfo) throws Exception {	
		return invoiceCustomerMasterDAO.getInvoiceCustomerMaster(userInfo);
	}
	 /**
	 * This method is used to fetch the active Invoicecustomermaster objects for the
	 * specified Invoicecustomermaster name and site.
	...
	public ResponseEntity<Object> getCustomerMaster(UserInfo userInfo) throws Exception {	
		return invoiceCustomerMasterDAO.getCustomerMaster(userInfo);
	}
	 /**
	 * This method is used to fetch the active Invoicecustomermaster objects for the
	 * specified Invoicecustomermaster name and site.
	 ...
	 */
	@Override
	public ResponseEntity<Object> getActiveInvoiceCustomerMasterById(int ncustomercode,UserInfo userInfo) throws Exception {
		
		return invoiceCustomerMasterDAO.getActiveInvoiceCustomerMasterById(ncustomercode, userInfo);
	...
	public ResponseEntity<Object> createInvoiceCustomerMaster(InvoiceCustomerMaster objInvoiceCustomerMaster,UserInfo userInfo) throws Exception {
		return invoiceCustomerMasterDAO.createInvoiceCustomerMaster(objInvoiceCustomerMaster,userInfo);
	}
	/**
	...
	public ResponseEntity<Object> updateInvoiceCustomerMaster(InvoiceCustomerMaster objInvoiceCustomerMaster,UserInfo userInfo) throws Exception {
		return invoiceCustomerMasterDAO.updateInvoiceCustomerMaster(objInvoiceCustomerMaster,userInfo);
	}
	...
	public ResponseEntity<Object> deleteInvoiceCustomerMaster(InvoiceCustomerMaster objInvoiceCustomerMaster,UserInfo userInfo) throws Exception {		
		return invoiceCustomerMasterDAO.deleteInvoiceCustomerMaster(objInvoiceCustomerMaster,userInfo);
	}
	 /**
		 * This method is used to fetch the active Invoicecustomermaster objects for the
		 * specified Invoicecustomermaster name and site.
	...
	public ResponseEntity<Object> getSelectedCustomerDetail(UserInfo userInfo, int ncustomercode) throws Exception {
		...
		return invoiceCustomerMasterDAO.getSelectedCustomerDetail(userInfo,ncustomercode);
	}
	/**
	 * This method is used to add a new entry to Invoicecustomermaster table. Need to
	 * check for duplicate entry of Invoicecustomermaster name for the specified site
	 ...
	 */
	 @Override
	    @Transactional(readOnly = false, rollbackFor = Exception.class)
	public ResponseEntity<Object> createCustomerFile(MultipartHttpServletRequest request,  UserInfo objUserInfo)throws Exception {
			return invoiceCustomerMasterDAO.createCustomerFile(request, objUserInfo);
	}
	...
	public ResponseEntity<Object> deleteCustomerFile(CustomerFile objCustomerFile, UserInfo objUserInfo)throws Exception {
			return invoiceCustomerMasterDAO.deleteCustomerFile(objCustomerFile, objUserInfo);
	}
	 /**
		 * This method is used to update entry in Invoicecustomermaster table. Need to
		 * validate that the Invoicecustomermaster object to be updated is active before
	...
	public ResponseEntity<Object> updateCustomerFile(MultipartHttpServletRequest request,  UserInfo objUserInfo)throws Exception {
		return invoiceCustomerMasterDAO.updateCustomerFile(request, objUserInfo);
	}
	 /**
		 * This method is used to update entry in Invoicecustomermaster table. Need to
		 * validate that the Invoicecustomermaster object to be updated is active before
		 ...
		 */
	@Override
	public ResponseEntity<Object> editCustomerFile(CustomerFile objCustomerFile, UserInfo objUserInfo) throws Exception {
		return invoiceCustomerMasterDAO.editCustomerFile(objCustomerFile,objUserInfo);
	}
	 /**
	 * This method is viewAttachedCustomerFile the active Invoicecustomermaster objects for the
	 * specified Invoicecustomermaster name and site.
	 * 
	 * @param ntypecode       [String] name of the Invoicecustomermaster
	 * @param nmasterSiteCode [int] site code of the Invoicecustomermaster
	...
	@Override
	 @Transactional(readOnly = false, rollbackFor = Exception.class)
	public Map<String, Object> viewAttachedCustomerFile(CustomerFile objCustomerFile, UserInfo objUserInfo)
			throws Exception {
		return invoiceCustomerMasterDAO.viewAttachedCustomerFile(objCustomerFile, objUserInfo);
	}
	 ...
	 * @throws Exception that are thrown from this DAO layer
	 */
	public ResponseEntity<Object> createControlRights( UserInfo userInfo, UserRoleFieldControl userroleController,List<UsersRoleField> lstusersrolescreen,int nflag, int nneedrights) throws Exception{
		
		return invoiceCustomerMasterDAO.createControlRights(userInfo,userroleController,lstusersrolescreen,nflag,  nneedrights);
	}
	/**
	 * This method is used to add a new entry to Invoicecustomermaster table. Need to
	 * check for duplicate entry of Invoicecustomermaster name for the specified site
