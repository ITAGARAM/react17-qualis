 ...
 * 'invoicecurrencytype' table
 */
public interface InvoiceCurrencyTypeService {
	/**
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> getActiveInvoiceCurrencyTypeById(final int ncurrencycode, UserInfo userInfo)
			throws Exception;
