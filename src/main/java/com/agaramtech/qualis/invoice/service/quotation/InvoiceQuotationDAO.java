 ...
 */
public interface InvoiceQuotationDAO {
	/**
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	ResponseEntity<Object> updateProductQuotation(final Map<String, Object> inputMap, final UserInfo userInfo)
			throws Exception;
	 ...
	 * @throws Exception that are thrown in the DAO layer
	 */
	public ResponseEntity<Object> getProductTestDetails(UserInfo userInfo);
