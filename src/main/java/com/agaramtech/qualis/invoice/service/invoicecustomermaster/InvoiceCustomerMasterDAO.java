...
public interface InvoiceCustomerMasterDAO {
	/**
	 ...
	 * @throws Exception that are thrown from this DAO layer
	 */
	public ResponseEntity<Object> editCustomerFile(final CustomerFile objCustomerFile,  UserInfo objUserInfo)throws Exception;
	/**
	 * This method is used to viewAttachedCustomerFile Invoicecustomermaster objects for the
	 * specified Invoicecustomermaster name and site.
	 * 
	 * @param ntypecode       [String] name of the Invoicecustomermaster
	 * @param nmasterSiteCode [int] site code of the Invoicecustomermaster
	 ...
	 * @throws Exception
	 */
	public Map<String, Object> viewAttachedCustomerFile(CustomerFile objCustomerFile, UserInfo objUserInfo)throws Exception;
	/**
	 ...
	 * @throws Exception
	 */
	public InvoiceCustomerMaster getActiveInvoiceCustomerMasterByIdforUpdate(int ncustomercode,UserInfo userInfo) throws Exception;
	...
	public ResponseEntity<Object> getInvoiceCustomermaster(com.agaramtech.qualis.global.UserInfo userInfo) throws Exception;
}
