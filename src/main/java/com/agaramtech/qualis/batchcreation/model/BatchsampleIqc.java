...
public class BatchsampleIqc extends CustomizedResultsetRowMapper<BatchsampleIqc> implements Serializable, RowMapper<BatchsampleIqc> {
	...
	@Transient
	private transient String smaterialtype; 
	...
	@Transient
	private transient float nqtyused; 
	...
	public BatchsampleIqc mapRow(ResultSet arg0, int arg1) throws SQLException {
		...
		objBatchSampleIQC.setSage(getString(arg0,"sage",arg1));
		objBatchSampleIQC.setSgendername(getString(arg0,"sgendername",arg1));
		objBatchSampleIQC.setSperiodname(getString(arg0,"speriodname",arg1));
