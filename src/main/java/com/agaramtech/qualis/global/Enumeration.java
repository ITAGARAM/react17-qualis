...
public class Enumeration {
	...
	public enum TransactionStatus {
		NA(-1), DELETED(-1), NON_EMPTY(0), ALL(0), ACTIVE(1), MASTER(1), CHECKLIST_TEMPLATE_VIEW(1), SEQUENCEONE(1),
		INHOUSE(1), STANDARDTYPE(1), OUTSIDE(2), // for material Qty transaction
		DEACTIVE(2), TRANSACTION(2), VOLUMETRICTYPE(2), CHECKLIST_TEST_GROUP_TEMPLATE_VIEW(2), YES(3),
		CHECKLIST_RESULTENTRY_VIEW(3), MATERIALINVENTORYTYPE(3), NO(4), DAYPERIOD(4), IQCSTANDARDMATERIALTYPE(4),
		LOCK(5), MONTHPERIOD(5), UNLOCK(6), YEARPERIOD(6), RETIRED(7), DRAFT(8), MANUAL(9), SYSTEM(10), START(11),
		STARTED(11), RESTART(12), STOP(13), RECEIVED(14), GOODS_IN(15), GOODS_RECEIVED(16), PREREGISTER(17),
		REGISTERED(18), RECIEVED_IN_SECTION(19), ALLOTTED(20), RE_SCHEDULED(21), ACCEPTED(22), INITIATED(23),
		RECALC(24), COMPLETED(25), RECOM_RECALC(26), RECOM_RETEST(27), CHECKED(28), REVIEWED(29), VERIFIED(30),
		APPROVED(31), RETEST(32), RELEASED(33), REJECTED(34), CANCELED(35), PARTIALLY(36), QUARENTINE(37),
		AUTHORISED(38), HOLD(39), RESERVED(40), SCHEDULED(41), INVITED(42), ISSUE(43), AUTO(44), PASS(45), FAIL(46),
		WITHDRAWN(47), CORRECTION(48), CERTIFIED(49), EXPIRED(50), INSERTED(51), UPDATED(52), VALIDATION(54),
		UNDERVALIDATION(55), CALIBIRATION(56), UNDERCALIBIRATION(57), MAINTANENCE(58), UNDERMAINTANENCE(59),
		CONDUCTED(60), ATTENDED(61), ACCREDIT(62), NOTACCREDIT(63), RETURN(64), WORKFLOW(65), SEND_REPORT(66),
		CERTIFICATECORRECTION(67), OVERDUE(68), REMAINDER(69), SENT(70), NULLIFIED(71), AUTO_ALLOT(72),
		AUTO_COMPLETE(73), AUTO_APPROVAL(74), PARTIAL_APPROVAL(75), SECTIONWISE_APPROVAL(76), ESIGN(77),
		JOB_ALLOCATION(78), BLACKLIST(79), DISCARD(80), OBSOLETE(81), CLOSED(81), GENERATED(82), PREPARED(83),
		SENDTOSTORE(84), CENTRALTOLOCAL(85), LOCALTOCENTRAL(86), BIDIRECTIONAL(87), SUCCESS(88), FAILED(89),
		INTERMEDIATE(90), DISPOSED(91), USED(91), OFFSITE(92), // Send to Store
		SENTSUCCESS(93), SENTFAILED(94), RECEIVESUCCESS(95), RECEIVEFAILED(96), RETRIEVED(97), PRELIMINARYRELEASE(98),
		EMPTY(101), UNPROCESSED(112), PROCESSED(113), ALIQUOTED(114), STORED(115), LOGIN(170),TOBEDISPOSE(116),	TOBESEND(106),
		RECEIVEDBYSTT(107),	RESULTRECEIVED(108), TOBERETURN(121), MOVETODISPOSE(119), MOVETORETURN(120),REQUESTED(118),PLANNED(117),AMENDED(122);
	...
	public enum ModuleCode {
		USERMANAGEMENT(3), SAMPLEREGISTRATION(10), RESULTENTRY(11), APPROVAL(12), BATCH(16), JOBALLOCATION(28),
		STABILITY(73);
	...
	public enum QualisForms {
		USERS(3), GOODSIN(7), MATERIALCATEGORY(23), PRODUCTCATEGORY(24), INSTRUMENTCATEGORY(27), TESTMASTER(41),
		SAMPLEREGISTRATION(43), APPROVALCONFIGURATION(55), RESULTENTRY(56), APPROVAL(61),TESTAPPROVAL(61), TESTGROUP(62),
		REPORTCONFIG(77), CLOCKHISTORY(94), CLOCKMONITORING(94), MYJOB(107), BARCODE(108), JOBALLOCATION(110),
		TESTWISEMYJOB(142), RELEASE(143), SAMPLESTORAGEMASTER(169), PROJECT(172), WORKLIST(173), BATCHCREATION(174),
		SCHEDULERCONFIGURATION(244), PROTOCOL(245), STABILITY(246),AUDITPLAN(266),INVOICE(283),SAMPLEREQUESTINGPLAN(296),
		LOCATIONBOXBARCODE(313),REPOSITORYIDBARCODE(312),PARENTSAMPLEBARCODE(310);
	...
	// STATUS_DELETE(0), STATUS_ACTIVE(1), STATUS_USER_LEVELS(1), STATUS_USERS(2),
	// DATE_CONTROLCODE(5),
	//		TISSUEVERIFY(16);
	//
	...
	public enum ReturnStatus {
		...
		CLINICALSPECALREADYEXISTS("IDS_CLICICALSPECALREADYEXISTS"), ALREADYOPENED("IDS_ALREADYCLOSED"),
		ALREADYCLOSED("IDS_ALREADYCLOSED"), RETURNSTRING("rtn"), RETURNVALUE("value"),
		ALREADYAPPROVED("IDS_ALREADYAPPROVED"), ALREADYRETIRED("IDS_ALREADYRETIRED"),
		...
		ALREADYREJECTED("IDS_ALREADYREJECTED"), SAMPLEINPROGRESS("IDS_SAMPLEINPROGRESS"),
		TABLOCK(" IN access exclusive mode"), SAMPLECODENOTAVAILABLE("IDS_SAMPLECODENOTAVAILABLE"),
		SAMPLEEXISTS("IDS_SAMPLEEXISTS"), NOSAMPLE("NOSAMPLE"), LOCATIONDELETED("IDS_LOCATIONDELETED"),
		CALIBRATED("AutoCalibrated"), UNDERCALIBRATED("AutoUnderCalibration"),
		...
		RELEASEDSAMPLESNOTAVAILABLEFORPURGE("Released samples not available for purge"), NODATAFOUND("No Data Found"), // on
		// 14/08/2020
		...
		ALREADYRECEIVED("IDS_ALREADYRECEIVED"), ALREADYATTENDED("IDS_ALREADYATTENDED"),
		ALREADYCOMPETENT("IDS_ALREADYCOMPETENT"), ALREADYINVITED("IDS_ALREADYINVITED"),
		...
		THISUSERALREADYLOGGEDIN("IDS_THISUSERALREADYLOGGEDIN"),
		THISUSERROLEALREADYLOGGEDIN("IDS_THISUSERROLEALREADYLOGGEDIN"), INVALIDLICENSECOUNT("IDS_INVALIDLICENSECOUNT"),
		
		//Added for BGSI
		NOTVALIDSUBJECTID("IDS_NOTVALIDSUBJECTID"),
		//ALPDJ21-44 - ARNO sequence Format - L.Subashini -09/08/2025
		SEQUENCEFORMATALREADYEXISTS("IDS_SEQUENCEFORMATALREADYEXISTS"),
		ACTIVEROLECANNOTBEDELETED("IDS_DELETEACTIVEROLE");
	...
	public enum Grade {
		NA(-1), PASS(1), OOT(2), L_OOS(3), FIO(4), DISREGARD(5), H_LOQ(6), H_LOD(7), L_LOQ(8), L_LOD(9), H_OOT(10),
		H_OOS(11),OOS(12);
	...
	public enum FTP {
		...
		DOWNLOAD_PATH("\\webapps\\ROOT\\SharedFolder\\Downloads\\"), FILE_PATH_TO_UPLOAD("/SharedFolder/Downloads/"),
		REPORTVIEW_FILE_PATH("/SharedFolder/ReportView/"), INVOICE_EXPORT("\\webapps\\ROOT\\SharedFolder\\Export\\"),
		UBUNTU_AWS_DOWNLOAD_PATH("webapps/ROOT/SharedFolder/Downloads/");
	...
	public enum SampleType {
		SUBSAMPLE(-1), PRODUCT(1), INSTRUMENT(2), MATERIAL(3), // STORAGECATEGORY(4),
		MASTERS(4), CLINICALSPEC(5), PROJECTSAMPLETYPE(6), GOODSIN(7), STABILITY(9), PROTOCOL(8);
	...
	public enum FormCode {
		USERS(3), MATERIALCATEGORY(23), PRODUCTCATEGORY(24), INSTRUMENTCATEGORY(27), TESTMASTER(41),
		SAMPLEREGISTRATION(43), RESULTENTRY(56), APPROVAL(61), TESTGROUP(62), REPORTCONFIG(77), CLOCKMONITORING(94),
		MYJOB(107), BARCODE(108), JOBALLOCATION(110), TESTWISEMYJOBS(142), RELEASE(143), PROJECT(172),
		BATCHCREATION(174), WORKLIST(173), PROTOCOL(245),BIODIRECTTRANSFER(273),BGSIRETURN(282),REQUESTBASEDTRANSFER(281),
		ECATALOGREQUESTAPPROVAL(301),DISPOSALSAMPLESPPROVAL(287),THIRDPARTYRETURN(298);
	...
	// ALPD-4393 17/06/2024 Abdul Gaffoor.A To validate ads password of login User
	// and to get ads user details and update it
	...
	public enum Condition {
		EQUALS(1), NOTEQUALS(2), CONTAINS(3), NOTCONTAINS(4), STARTSWITH(5), ENDSWITH(6), INCLUDES(7), LESSTHAN(8),
		LESSTHANOREQUALS(9), GREATERTHAN(10), GREATERTHANEQUALS(11);
	...
	public enum DesignProperties {
		LABEL(1), VALUE(2), LISTITEM(3), SINGLEITEMDATA(4), GRIDITEM(5), GRIDEXPANDABLEITEM(6), LISTMOREITEM(7),
		LISTMAINFIELD(8), COLOUR(9);
	...
	public enum ApprovalStatusFunction {
		FILTERSTATUS(1), VALIDATIONSTATUS(2), SAMPLEREGISTRATIONFILTER(9);
	...
	public enum CommentSubType {
		TEST_COMMENTS(1), SAMPLE_COMMENTS(2), PREDEFINED_TEST_COMMENTS(3), DEVIATION_COMMENTS(5), REPORTS_COMMENTS(4),
		GENERAL_COMMENTS(6);
	...
	public enum DatabaseDateFormat {
		FORMAT_1("yyyy-MM-dd HH24:mi:ss"), FORMAT_2("yyyy-MM-dd HH:mm:ss");
	...
	public enum Period{
		Weeks(3), Days(4), Month(5), Years(6), Hours(2), Never(8), Minutes(1), NA(-1); // Added by sonia on 04th Mar
																						// 2025 for jira id:ALPD-5504
	...
	public enum ExternalOrderType {
		PORTAL(1), PREVENTTB(2), OPENMRS(3), LIMS(4), MANUAL(-1);
	...
	public enum LicenseType {
		...
		CONCURRENTNOSESSION(1), CONCURRENTUSERBASEDSESSION(2), CONCURRENTUSERROLEBASEDSESSION(3), NAMEDLICENSE(4);
	...
	public enum Settings {
		...
		FILE_VIEW_SOURCE(2), ATTACHMENT_DOWNLOAD_URL(6), SHOW_TIMEZONE(19), // Added by sonia on 18th July 2025 for jira
																			// id:ALPDJ21-18
		NEED_UTC(21), //Added by sonia on 18th July 2025 for jira id:ALPDJ21-18
		NEED_SMTL_JSON_TEMPLATE(29), 
		//Added by L.Subashini 23/09/2025
		STORAGE_MAPPING_RECORD(40),
		ALLOT_JOB_OPTIONAL(43), UPDATING_ANALYSER(45),
		SCHEDULER_BASED_STATUS_UPDATE_TO_PORTAL(52), EXPORTVIEW_URL(56), INTEGRATION_SERVICE(58),
		DELETE_EXCEPTION_LOG(59), NFCOLDREPORT_PATH(61), WEBSERVER_PATH(62), COAREPORT_GENERATION(64), LOGINADSSYNC(65),
		COAREPORTVIEW_URL(66), DEPLOYMENTSERVER_HOMEPATH(67), REPORT_OPEN_NEW_TAB(70), AUTO_CALIBRATION(73), // Added by
																												// sonia
																												// on
																												// 27th
																												// Sept
																												...
																												// Jira
																												// idL:ALPD-4939;
		SYNC_DATA_RETRY_COUNT(74), DAUGHTERALIQUOTPLAN(75), SILIENTAUDITENABLE(80), CAPTCHA(81), // Added for sonia on
																									// 16th June 2025
																									// for jira
																									// id:ALPD-6028
		//#SECURITY-VULNERABILITY-MERGING-START																							// (Captcha
		/*																							// Validation)
		MFA(83), INSTRUMENT_BASED_STORAGE(84), NEEDS3STORAGE(86),CLOUD_PRINTER(88),NEED_VACUUM(89),
		SEND_MAIL_REJECT(92),HL7CONVERSION(96),RETRIEVBASEDSTORESAMPLE(87),BARCODESPLIT(36),SESSIONTIMEOUT(102),SESSIONCLEAROUTTIME(103);
		*/
		
		MFA(83), INSTRUMENT_BASED_STORAGE(84), NEEDS3STORAGE(86),CLOUD_PRINTER(88),NEED_VACUUM(89),
		JWT_EXPIRYTIME(82), RATELIMITPERSECOND(99), RATELIMITPERDAY(100),
		SEND_MAIL_REJECT(92),HL7CONVERSION(96),RETRIEVBASEDSTORESAMPLE(87),BARCODESPLIT(36),SESSIONTIMEOUT(102),SESSIONCLEAROUTTIME(103);
	...
	public enum PublicAPIEndPoints {
		...
		GET_LOGIN_INFO("/login/getloginInfo"), GET_LOGIN_VALIDATION("/login/getloginvalidation"),
		INTERNAL_LOGIN("/login/internallogin"), ADS_LOGIN("/login/adsLogin"), GET_ALERTS("/alertview/getAlerts"),
		UNAUTHORIZED_ACCESS("/authorization/invalidToken"), LOGIN_AUDITACTION("login/insertAuditAction");
	...
	/*
	 * Created By: RAJESH KUMAR.K Created on : 30/09/2024 Purpose : Wrapper class
	 * enum will be used in casting the object in JdbcTemplateUtitlity class
	 */
	...
	public enum CategoryType {
		SUPPLIERCATEGORY(1), MATERIALCATEGORY(2), NA(-1);
	...
	public enum DynamicInitialValue {
		QUERYBUILDERVIEWS(5000), QUERYTABLEDETAILS(5000), QUERYBUILDERTABLES(5000), DYNAMICFORMS(5000),
		DYNAMICMODULE(1000);
	...
	public enum TransAction {
		SAMPLEREGISTERED("IDS_SAMPLEREGISTERED"), RECIEVEDBY("IDS_SAMPLERECEIVEDIN"),
		SENDTOSRORE("IDS_SAMPLEISSENDTOSTORED"), SAMPLEDISCARD("IDS_SAMPLEDISCARD"),
		BATCHINITIATED("IDS_SAMPLEUSEDFORBATCHRUN"), TESTINITIATED("IDS_SAMPLEUSEDFOR"),
		ALLIQUOTEDTO("Sample Alliquoted For "), RESERVEDFOR("Reserved For Store");
	...
	public enum StringTokens{
		SEMICOLON(";"), OPEN_PARENTHESIS("("), CLOSE_PARENTHESIS(")"), SPACE(" "), COMMA(",");
	...
	public enum EntityMapper {
		MAPROW("mapRow"), TABLENAME("stablename"), SEQUENCENO("nsequenceno");
	...
	public enum ChecklistComponent {
		COMBOBOX(1), TEXTBOX(2), TEXTAREA(3), CHECKBOX(4), LABEL(5), BUTTON(6), DATEFEILD(7), RADIOBUTTON(8),
		SERARCHLIST(9);
	...
	public enum MFASettings {
		...
		OTP_EXPIRY_MINUTES(1), EMAIL_EDIT_OPTION(2);
	...
	// ALPDJ21-31-->Added by Vignesh(23-07-2025)-->Added the new dropdown Instrument
	// Type-Standard, Storage
		public enum InstrumentType {

		NA(-1), STANDARD_INSTRUMENT(1), STORAGE_INSTRUMENT(2),TEMPORARY_STORAGE_INSTRUMENT(3);
	...
	public enum DiagnosticType {
		NOT_IDENTIFIED(1), CANCER(2), NON_CANCER(3);

		private final int ndiagnostictypecode;

		private DiagnosticType(int ndiagnostictypecode) {
			this.ndiagnostictypecode = ndiagnostictypecode;
		}

		public int getndiagnostictypecode() {
			return ndiagnostictypecode;
		}
	}
	...
	public enum StorageType {
		...
		private final int nstoragetypecode;

		private StorageType(int nstoragetypecode) {
			this.nstoragetypecode = nstoragetypecode;
		}

		public int getnstoragetypecode() {
			return nstoragetypecode;
		}
	}

	//ALDP-5351 Sathish - 05-02-2025
		public enum SupplierType {

		SUPPLIER(1), SUBCONTRACTOR(2);
			...
			private SupplierType(int SupplierType) {
				this.SupplierType = SupplierType;
			}
		}
		
	//added by sujatha v ATE-274 for EmployeeType Enumeration
	public enum EmployeeType{

		LIMSEMPLOYEE(1), OUTSOURCEEMPLOYEE(2);

		private final int nemptypecode;

		private EmployeeType(int nemptypecode) {
			this.nemptypecode = nemptypecode;
			}
	...
	//added by Abdul Gaffoor A for BGSi-E-catalogue Request
	public enum TransferType {
		BIOBANK(1), BIOBANKEXTERNAL(2), THIRDPARTY(3);
 
		private final int ntransfertype;
 
		private TransferType(int ntransfertype) {
			this.ntransfertype = ntransfertype;
		}
 
		public int getntransfertype() {
	...
	public enum EmailType{
		CONTROLBASEDMAIL(1), SCHEDULEDBASEDMAIL(2);
		
		private final int nemailtypecode;

		private EmailType(int nemailtypecode) {
			this.nemailtypecode = nemailtypecode;
		}

		public int getEmailType() {
			return nemailtypecode;
		}
	}
		
		//added by Vishakh for BGSiReturn
		public enum FormType {
			Transfer(1), Return(2);
	 
			private final int nformtype;
	 
			private FormType(int nformtype) {
				this.nformtype = nformtype;
		}
	 
			public int getnformtype() {
				return nformtype;
			}
		}
		
		//Add Maruthu - INVOICE MODULE - 20-SEP-2025
	...
	// ate234 Janakumar BGSI Work
	public enum RequestFormType {
		 BIOSAMPLEBASED(1), PARENTSAMPLEBASED(2);

		private RequestFormType(int requestformtype) {
			this.requestformtype = requestformtype;
}

		private final int requestformtype;
