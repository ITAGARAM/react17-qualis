...
public class UserInfo {
	...
	private short ninputtimezonecode;
	private String sdecimaloperator;
	private String semail;
	private int nsessiontimeout; //ALPDJ21-132--Added by Ganesh(21-11-2025)--for session time update.
	...
	public UserInfo(UserInfo userInfo) {
		...
		this.ninputtimezonecode =userInfo.ninputtimezonecode; //Added by sonia on 18th July 2025 for jira id:ALPDJ21-18
		this.sdecimaloperator =userInfo.sdecimaloperator; //Added by Abdul on 04 Sept 2025 for BGSi-72
		this.semail=userInfo.semail; // Added by gowtham(18-09-2025) for SWSM-48
		this.nsessiontimeout=userInfo.nsessiontimeout; //ALPDJ21-132--Added by Ganesh(21-11-2025)--for session time update.
	}
}
