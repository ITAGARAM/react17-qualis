...
public class ContainerType extends CustomizedResultsetRowMapper<ContainerType> implements Serializable, RowMapper<ContainerType> {
	...
	@ColumnDefault("4")
	@Column(name = "nsamplecontainer", nullable = false)
	private short nsamplecontainer ;
	
	@Transient
	private transient String stransdisplaystatus;

	@Override
	public ContainerType mapRow(final ResultSet arg0, final int arg1) throws SQLException {
		...
		containerType.setNsamplecontainer(getShort(arg0, "nsamplecontainer", arg1));
		containerType.setStransdisplaystatus(StringEscapeUtils.unescapeJava(getString(arg0, "stransdisplaystatus", arg1)));
