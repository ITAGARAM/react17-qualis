...
public class Barcode extends CustomizedResultsetRowMapper<Barcode> implements Serializable, RowMapper<Barcode> {
	...
	@Transient
	private String slabelformattypename;
	@Transient 
	...
	public Barcode mapRow(ResultSet arg0, int arg1) throws SQLException {
		...
		barcode.setNlabelformattypecode(getShort(arg0, "nlabelformattypecode", arg1));
		barcode.setSlabelformattypename(getString(arg0, "slabelformattypename", arg1));
		barcode.setNlabelcolumncount(getShort(arg0, "nlabelcolumncount", arg1));
